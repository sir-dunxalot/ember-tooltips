...
this.get("isDestroying")||(Ember.run.cancel(this.get("_showTimer")),Ember.run.later(function(){e.get("_isMouseInside")||e._hideTooltip()},+this.get("popoverHideDelay")))}})}),define("ember-tooltips/components/ember-tooltip-base",["exports","tooltip.js","ember-get-config","ember-tooltips/templates/components/ember-tooltip-base"],function(e,t,n,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
...
this._spacingRequestId||!this.get("isShown")||this.get("isDestroying")||(this._spacingRequestId=requestAnimationFrame(function(){if(e._spacingRequestId=null,e.get("isShown")&&!e.get("isDestroying")){var t,n=e.get("_tooltip").popperInstance.popper,r=a(n.getAttribute("x-placement")),i=n.style
