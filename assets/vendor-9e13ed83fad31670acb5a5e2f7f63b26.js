...
try{e&&ye(i=e.promise)?i.call(e).done(t).fail(n):e&&ye(i=e.then)?i.call(e,t,n):t.apply(void 0,[e].slice(r))}catch(e){n.apply(void 0,[e])}}function f(){se.removeEventListener("DOMContentLoaded",f),e.removeEventListener("load",f),we.ready()}function h(e,t){return t.toUpperCase()}function d(e){return e.replace(Ie,"ms-").replace(Le,h)}function m(){this.expando=we.expando+m.uid++}function g(e){return"true"===e||"false"!==e&&("null"===e?null:e===+e+""?+e:ze.test(e)?JSON.parse(e):e)}function v(e,t,n){var r
if(void 0===n&&1===e.nodeType)if(r="data-"+t.replace(He,"-$&").toLowerCase(),"string"==typeof(n=e.getAttribute(r))){try{n=g(n)}catch(e){}Ue.set(e,t,n)}else n=void 0
return n}function y(e,t,n,r){var i,o,s=20,a=r?function(){return r.cur()}:function(){return we.css(e,t,"")},u=a(),l=n&&n[3]||(we.cssNumber[t]?"":"px"),c=(we.cssNumber[t]||"px"!==l&&+u)&&Ve.exec(we.css(e,t))
...
return i||(t=n.body.appendChild(n.createElement(r)),i=we.css(t,"display"),t.parentNode.removeChild(t),"none"===i&&(i="block"),Qe[r]=i,i)}function _(e,t){for(var n,r,i=[],o=0,s=e.length;o<s;o++)r=e[o],r.style&&(n=r.style.display,t?("none"===n&&(i[o]=Be.get(r,"display")||null,i[o]||(r.style.display="")),""===r.style.display&&Ge(r)&&(i[o]=b(r))):"none"!==n&&(i[o]="none",Be.set(r,"display",n)))
for(o=0;o<s;o++)null!=i[o]&&(e[o].style.display=i[o])
return e}function w(e,t){var n
return n=void 0!==e.getElementsByTagName?e.getElementsByTagName(t||"*"):void 0!==e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&o(e,t)?we.merge([e],n):n}function E(e,t){for(var n=0,r=e.length;n<r;n++)Be.set(e[n],"globalEval",!t||Be.get(t[n],"globalEval"))}function x(e,t,n,i,o){for(var s,a,u,l,c,p,f=t.createDocumentFragment(),h=[],d=0,m=e.length;d<m;d++)if((s=e[d])||0===s)if("object"===r(s))we.merge(h,s.nodeType?[s]:s)
...
else if(c=we.contains(s.ownerDocument,s),a=w(f.appendChild(s),"script"),c&&E(a),n)for(p=0;s=a[p++];)Je.test(s.type||"")&&n.push(s)
return f}function C(){return!0}function O(){return!1}function A(){try{return se.activeElement}catch(e){}}function S(e,t,n,r,i,o){var s,a
...
return 1===o&&(s=i,i=function(e){return we().off(e),s.apply(this,arguments)},i.guid=s.guid||(s.guid=we.guid++)),e.each(function(){we.event.add(this,t,i,r,n)})}function T(e,t){return o(e,"table")&&o(11!==t.nodeType?t:t.firstChild,"tr")?we(e).children("tbody")[0]||e:e}function R(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function k(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function N(e,t){var n,r,i,o,s,a,u,l
if(1===t.nodeType){if(Be.hasData(e)&&(o=Be.access(e),s=Be.set(t,o),l=o.events)){delete s.handle,s.events={}
for(i in l)for(n=0,r=l[i].length;n<r;n++)we.event.add(t,i,l[i][n])}Ue.hasData(e)&&(a=Ue.access(e),u=we.extend({},a),Ue.set(t,u))}}function j(e,t){var n=t.nodeName.toLowerCase()
"input"===n&&$e.test(e.type)?t.checked=e.checked:"input"!==n&&"textarea"!==n||(t.defaultValue=e.defaultValue)}function P(e,t,r,i){t=le.apply([],t)
var o,s,a,u,l,c,p=0,f=e.length,h=f-1,d=t[0],m=ye(d)
if(m||f>1&&"string"==typeof d&&!ve.checkClone&&st.test(d))return e.each(function(n){var o=e.eq(n)
m&&(t[0]=d.call(this,n,o.html())),P(o,t,r,i)})
if(f&&(o=x(t,e[0].ownerDocument,!1,e,i),s=o.firstChild,1===o.childNodes.length&&(o=s),s||i)){for(a=we.map(w(o,"script"),R),u=a.length;p<f;p++)l=o,p!==h&&(l=we.clone(l,!0,!0),u&&we.merge(a,w(l,"script"))),r.call(e[p],l,p)
if(u)for(c=a[a.length-1].ownerDocument,we.map(a,k),p=0;p<u;p++)l=a[p],Je.test(l.type||"")&&!Be.access(l,"globalEval")&&we.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?we._evalUrl&&we._evalUrl(l.src):n(l.textContent.replace(at,""),c,l))}return e}function D(e,t,n){for(var r,i=t?we.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||we.cleanData(w(r)),r.parentNode&&(n&&we.contains(r.ownerDocument,r)&&E(w(r,"script")),r.parentNode.removeChild(r))
return e}function M(e,t,n){var r,i,o,s,a=e.style
return n=n||lt(e),n&&(s=n.getPropertyValue(t)||n[t],""!==s||we.contains(e.ownerDocument,e)||(s=we.style(e,t)),!ve.pixelBoxStyles()&&ut.test(s)&&ct.test(t)&&(r=a.width,i=a.minWidth,o=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=n.width,a.width=r,a.minWidth=i,a.maxWidth=o)),void 0!==s?s+"":s}function I(e,t){return{get:function(){return e()?void delete this.get:(this.get=t).apply(this,arguments)}}}function L(e){if(e in gt)return e
for(var t=e[0].toUpperCase()+e.slice(1),n=mt.length;n--;)if((e=mt[n]+t)in gt)return e}function F(e){var t=we.cssProps[e]
return t||(t=we.cssProps[e]=L(e)||e),t}function B(e,t,n){var r=Ve.exec(t)
...
return!r&&o>=0&&(u+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-o-u-a-.5))),u}function z(e,t,n){var r=lt(e),i=M(e,t,r),o="border-box"===we.css(e,"boxSizing",!1,r),s=o
if(ut.test(i)){if(!n)return i
i="auto"}return s=s&&(ve.boxSizingReliable()||i===e.style[t]),("auto"===i||!parseFloat(i)&&"inline"===we.css(e,"display",!1,r))&&(i=e["offset"+t[0].toUpperCase()+t.slice(1)],s=!0),(i=parseFloat(i)||0)+U(e,t,n||(o?"border":"content"),s,r,i)+"px"}function H(e,t,n,r,i){return new H.prototype.init(e,t,n,r,i)}function q(){yt&&(!1===se.hidden&&e.requestAnimationFrame?e.requestAnimationFrame(q):e.setTimeout(q,we.fx.interval),we.fx.tick())}function V(){return e.setTimeout(function(){vt=void 0}),vt=Date.now()}function W(e,t){var n,r=0,i={height:e}
for(t=t?1:0;r<4;r+=2-t)n=We[r],i["margin"+n]=i["padding"+n]=e
return t&&(i.opacity=i.width=e),i}function G(e,t,n){for(var r,i=($.tweeners[t]||[]).concat($.tweeners["*"]),o=0,s=i.length;o<s;o++)if(r=i[o].call(n,t,e))return r}function K(e,t,n){var r,i,o,s,a,u,l,c,p="width"in t||"height"in t,f=this,h={},d=e.style,m=e.nodeType&&Ge(e),g=Be.get(e,"fxshow")
...
for(n in o)n in e||(e[n]=o[n],t[n]=i)}else t[r]=i}function $(e,t,n){var r,i,o=0,s=$.prefilters.length,a=we.Deferred().always(function(){delete u.elem}),u=function(){if(i)return!1
for(var t=vt||V(),n=Math.max(0,l.startTime+l.duration-t),r=n/l.duration||0,o=1-r,s=0,u=l.tweens.length;s<u;s++)l.tweens[s].run(o)
return a.notifyWith(e,[l,o,n]),o<1&&u?n:(u||a.notifyWith(e,[l,1,0]),a.resolveWith(e,[l]),!1)},l=a.promise({elem:e,props:we.extend({},t),opts:we.extend(!0,{specialEasing:{},easing:we.easing._default},n),originalProperties:t,originalOptions:n,startTime:vt||V(),duration:n.duration,tweens:[],createTween:function(t,n){var r=we.Tween(e,l.opts,t,n,l.opts.specialEasing[t]||l.opts.easing)
return l.tweens.push(r),r},stop:function(t){var n=0,r=t?l.tweens.length:0
if(i)return this
for(i=!0;n<r;n++)l.tweens[n].run(1)
return t?(a.notifyWith(e,[l,1,0]),a.resolveWith(e,[l,t])):a.rejectWith(e,[l,t]),this}}),c=l.props
for(Q(c,l.opts.specialEasing);o<s;o++)if(r=$.prefilters[o].call(l,e,c,l.opts))return ye(r.stop)&&(we._queueHooks(l.elem,l.opts.queue).stop=r.stop.bind(r)),r
return we.map(c,G,l),ye(l.opts.start)&&l.opts.start.call(e,l),l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always),we.fx.timer(we.extend(u,{elem:e,anim:l,queue:l.opts.queue})),l}function Y(e){return(e.match(je)||[]).join(" ")}function J(e){return e.getAttribute&&e.getAttribute("class")||""}function X(e){return Array.isArray(e)?e:"string"==typeof e?e.match(je)||[]:[]}function Z(e,t,n,i){var o
...
else try{t=s(t)}catch(e){return{state:"parsererror",error:s?e:"No conversion from "+u+" to "+o}}}return{state:"success",data:t}}var oe=[],se=e.document,ae=Object.getPrototypeOf,ue=oe.slice,le=oe.concat,ce=oe.push,pe=oe.indexOf,fe={},he=fe.toString,de=fe.hasOwnProperty,me=de.toString,ge=me.call(Object),ve={},ye=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},be=function(e){return null!=e&&e===e.window},_e={type:!0,src:!0,noModule:!0},we=function(e,t){return new we.fn.init(e,t)},Ee=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g
...
return le.apply([],a)},guid:1,support:ve}),"function"==typeof Symbol&&(we.fn[Symbol.iterator]=oe[Symbol.iterator]),we.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){fe["[object "+t+"]"]=t.toLowerCase()})
var xe=function(e){function t(e,t,n,r){var i,o,s,a,u,c,f,h=t&&t.ownerDocument,d=t?t.nodeType:9
if(n=n||[],"string"!=typeof e||!e||1!==d&&9!==d&&11!==d)return n
if(!r&&((t?t.ownerDocument||t:B)!==N&&k(t),t=t||N,P)){if(11!==d&&(u=me.exec(e)))if(i=u[1]){if(9===d){if(!(s=t.getElementById(i)))return n
...
for(l&&(S=s===N||s||l);d!==E&&null!=(c=b[d]);d++){if(o&&c){for(p=0,s||c.ownerDocument===N||(k(c),a=!P);f=e[p++];)if(f(c,s||N,a)){u.push(c)
break}l&&(U=_)}i&&((c=!f&&c)&&h--,r&&g.push(c))}if(h+=d,i&&d!==h){for(p=0;f=n[p++];)f(g,v,s,a)
if(r){if(h>0)for(;d--;)g[d]||v[d]||(v[d]=Q.call(u))
v=m(v)}Y.apply(u,v),l&&!r&&v.length>0&&h+n.length>1&&t.uniqueSort(u)}return l&&(U=_,S=y),g}
return i?r(s):s}var b,_,w,E,x,C,O,A,S,T,R,k,N,j,P,D,M,I,L,F="sizzle"+1*new Date,B=e.document,U=0,z=0,H=n(),q=n(),V=n(),W=function(e,t){return e===t&&(R=!0),0},G={}.hasOwnProperty,K=[],Q=K.pop,$=K.push,Y=K.push,J=K.slice,X=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
...
return n||(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!_.sortDetached&&t.compareDocumentPosition(e)===n?e===N||e.ownerDocument===B&&L(B,e)?-1:t===N||t.ownerDocument===B&&L(B,t)?1:T?X(T,e)-X(T,t):0:4&n?-1:1)}:function(e,t){if(e===t)return R=!0,0
...
for(;a[r]===u[r];)r++
return r?s(a[r],u[r]):a[r]===B?-1:u[r]===B?1:0},N):N},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if((e.ownerDocument||e)!==N&&k(e),n=n.replace(ue,"='$1']"),_.matchesSelector&&P&&!V[n+" "]&&(!M||!M.test(n))&&(!D||!D.test(n)))try{var r=I.call(e,n)
if(r||_.disconnectedMatch||e.document&&11!==e.document.nodeType)return r}catch(e){}return t(n,N,null,[e]).length>0},t.contains=function(e,t){return(e.ownerDocument||e)!==N&&k(e),L(e,t)},t.attr=function(e,t){(e.ownerDocument||e)!==N&&k(e)
...
if(n=n||[],1===f.length){if(o=f[0]=f[0].slice(0),o.length>2&&"ID"===(s=o[0]).type&&9===t.nodeType&&P&&w.relative[o[1].type]){if(!(t=(w.find.ID(s.matches[0].replace(ve,ye),t)||[])[0]))return n
...
return n},Ae=we.expr.match.needsContext,Se=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i
...
return r>1?we.uniqueSort(n):n},filter:function(e){return this.pushStack(s(this,e||[],!1))},not:function(e){return this.pushStack(s(this,e||[],!0))},is:function(e){return!!s(this,"string"==typeof e&&Ae.test(e)?we(e):e||[],!1).length}})
var Te,Re=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(we.fn.init=function(e,t,n){var r,i
if(!e)return this
if(n=n||Te,"string"==typeof e){if(!(r="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:Re.exec(e))||!r[1]&&t)return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e)
...
return this}return i=se.getElementById(r[2]),i&&(this[0]=i,this.length=1),this}return e.nodeType?(this[0]=e,this.length=1,this):ye(e)?void 0!==n.ready?n.ready(e):e(we):we.makeArray(e,this)}).prototype=we.fn,Te=we(se)
...
if(!Ae.test(e))for(;r<i;r++)for(n=this[r];n&&n!==t;n=n.parentNode)if(n.nodeType<11&&(s?s.index(n)>-1:1===n.nodeType&&we.find.matchesSelector(n,e))){o.push(n)
...
return t&&11!==t.nodeType?t:null},parents:function(e){return Ce(e,"parentNode")},parentsUntil:function(e,t,n){return Ce(e,"parentNode",n)},next:function(e){return a(e,"nextSibling")},prev:function(e){return a(e,"previousSibling")},nextAll:function(e){return Ce(e,"nextSibling")},prevAll:function(e){return Ce(e,"previousSibling")},nextUntil:function(e,t,n){return Ce(e,"nextSibling",n)},prevUntil:function(e,t,n){return Ce(e,"previousSibling",n)},siblings:function(e){return Oe((e.parentNode||{}).firstChild,e)},children:function(e){return Oe(e.firstChild)},contents:function(e){return o(e,"iframe")?e.contentDocument:(o(e,"template")&&(e=e.content||e),we.merge([],e.childNodes))}},function(e,t){we.fn[e]=function(n,r){var i=we.map(this,t,n)
return"Until"!==e.slice(-5)&&(r=n),r&&"string"==typeof r&&(i=we.filter(r,i)),this.length>1&&(Ne[e]||we.uniqueSort(i),ke.test(e)&&i.reverse()),this.pushStack(i)}})
var je=/[^\x20\t\r\n\f]+/g
...
if("object"===r(n)){o=!0
for(u in n)Me(e,t,u,n[u],!0,s,a)}else if(void 0!==i&&(o=!0,ye(i)||(a=!0),c&&(a?(t.call(e,i),t=null):(c=t,t=function(e,t,n){return c.call(we(e),n)})),t))for(;u<l;u++)t(e[u],n,a?i:i.call(e[u],u,t(e[u],n)))
...
var Be=new m,Ue=new m,ze=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,He=/[A-Z]/g
we.extend({hasData:function(e){return Ue.hasData(e)||Be.hasData(e)},data:function(e,t,n){return Ue.access(e,t,n)},removeData:function(e,t){Ue.remove(e,t)},_data:function(e,t,n){return Be.access(e,t,n)},_removeData:function(e,t){Be.remove(e,t)}}),we.fn.extend({data:function(e,t){var n,r,i,o=this[0],s=o&&o.attributes
if(void 0===e){if(this.length&&(i=Ue.get(o),1===o.nodeType&&!Be.get(o,"hasDataAttrs"))){for(n=s.length;n--;)s[n]&&(r=s[n].name,0===r.indexOf("data-")&&(r=d(r.slice(5)),v(o,r,i[r])))
Be.set(o,"hasDataAttrs",!0)}return i}return"object"==typeof e?this.each(function(){Ue.set(this,e)}):Me(this,function(t){var n
if(o&&void 0===t){if(void 0!==(n=Ue.get(o,e)))return n
if(void 0!==(n=v(o,e)))return n}else this.each(function(){Ue.set(this,e,t)})},null,t,arguments.length>1,null,!0)},removeData:function(e){return this.each(function(){Ue.remove(this,e)})}}),we.extend({queue:function(e,t,n){var r
if(e)return t=(t||"fx")+"queue",r=Be.get(e,t),n&&(!r||Array.isArray(n)?r=Be.access(e,t,we.makeArray(n)):r.push(n)),r||[]},dequeue:function(e,t){t=t||"fx"
...
return Be.get(e,n)||Be.access(e,n,{empty:we.Callbacks("once memory").add(function(){Be.remove(e,[t+"queue",n])})})}}),we.fn.extend({queue:function(e,t){var n=2
...
var qe=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ve=new RegExp("^(?:([+-])=|)("+qe+")([a-z%]*)$","i"),We=["Top","Right","Bottom","Left"],Ge=function(e,t){return e=t||e,"none"===e.style.display||""===e.style.display&&we.contains(e.ownerDocument,e)&&"none"===we.css(e,"display")},Ke=function(e,t,n,r){var i,o,s={}
...
we.event={global:{},add:function(e,t,n,r,i){var o,s,a,u,l,c,p,f,h,d,m,g=Be.get(e)
if(g)for(n.handler&&(o=n,n=o.handler,i=o.selector),i&&we.find.matchesSelector(et,i),n.guid||(n.guid=we.guid++),(u=g.events)||(u=g.events={}),(s=g.handle)||(s=g.handle=function(t){return void 0!==we&&we.event.triggered!==t.type?we.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(je)||[""],l=t.length;l--;)a=rt.exec(t[l])||[],h=m=a[1],d=(a[2]||"").split(".").sort(),h&&(p=we.event.special[h]||{},h=(i?p.delegateType:p.bindType)||h,p=we.event.special[h]||{},c=we.extend({type:h,origType:m,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&we.expr.match.needsContext.test(i),namespace:d.join(".")},o),(f=u[h])||(f=u[h]=[],f.delegateCount=0,p.setup&&!1!==p.setup.call(e,r,d,s)||e.addEventListener&&e.addEventListener(h,s)),p.add&&(p.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),i?f.splice(f.delegateCount++,0,c):f.push(c),we.event.global[h]=!0)},remove:function(e,t,n,r,i){var o,s,a,u,l,c,p,f,h,d,m,g=Be.hasData(e)&&Be.get(e)
if(g&&(u=g.events)){for(t=(t||"").match(je)||[""],l=t.length;l--;)if(a=rt.exec(t[l])||[],h=m=a[1],d=(a[2]||"").split(".").sort(),h){for(p=we.event.special[h]||{},h=(r?p.delegateType:p.bindType)||h,f=u[h]||[],a=a[2]&&new RegExp("(^|\\.)"+d.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=o=f.length;o--;)c=f[o],!i&&m!==c.origType||n&&n.guid!==c.guid||a&&!a.test(c.namespace)||r&&r!==c.selector&&("**"!==r||!c.selector)||(f.splice(o,1),c.selector&&f.delegateCount--,p.remove&&p.remove.call(e,c))
...
we.isEmptyObject(u)&&Be.remove(e,"handle events")}},dispatch:function(e){var t,n,r,i,o,s,a=we.event.fix(e),u=new Array(arguments.length),l=(Be.get(this,"events")||{})[a.type]||[],c=we.event.special[a.type]||{}
...
e&&e.type?(this.originalEvent=e,this.type=e.type,this.isDefaultPrevented=e.defaultPrevented||void 0===e.defaultPrevented&&!1===e.returnValue?C:O,this.target=e.target&&3===e.target.nodeType?e.target.parentNode:e.target,this.currentTarget=e.currentTarget,this.relatedTarget=e.relatedTarget):this.type=e,t&&we.extend(this,t),this.timeStamp=e&&e.timeStamp||Date.now(),this[we.expando]=!0},we.Event.prototype={constructor:we.Event,isDefaultPrevented:O,isPropagationStopped:O,isImmediatePropagationStopped:O,isSimulated:!1,preventDefault:function(){var e=this.originalEvent
...
return this}return!1!==t&&"function"!=typeof t||(n=t,t=void 0),!1===n&&(n=O),this.each(function(){we.event.remove(this,e,n,t)})}})
...
if(!(ve.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||we.isXMLDoc(e)))for(s=w(a),o=w(e),r=0,i=o.length;r<i;r++)j(o[r],s[r])
if(t)if(n)for(o=o||w(e),s=s||w(a),r=0,i=o.length;r<i;r++)N(o[r],s[r])
else N(e,a)
return s=w(a,"script"),s.length>0&&E(s,!u&&w(e,"script")),a},cleanData:function(e){for(var t,n,r,i=we.event.special,o=0;void 0!==(n=e[o]);o++)if(Fe(n)){if(t=n[Be.expando]){if(t.events)for(r in t.events)i[r]?we.event.remove(n,r):we.removeEvent(n,r,t.handle)
n[Be.expando]=void 0}n[Ue.expando]&&(n[Ue.expando]=void 0)}}}),we.fn.extend({detach:function(e){return D(this,e,!0)},remove:function(e){return D(this,e)},text:function(e){return Me(this,function(e){return void 0===e?we.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return P(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){T(this,e).appendChild(e)}})},prepend:function(){return P(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=T(this,e)
...
o=typeof n,"string"===o&&(i=Ve.exec(n))&&i[1]&&(n=y(e,t,i),o="number"),null!=n&&n===n&&("number"===o&&(n+=i&&i[3]||(we.cssNumber[a]?"":"px")),ve.clearCloneStyle||""!==n||0!==t.indexOf("background")||(l[t]="inherit"),s&&"set"in s&&void 0===(n=s.set(e,n,r))||(u?l.setProperty(t,n):l[t]=n))}},css:function(e,t,n,r){var i,o,s,a=d(t)
return ft.test(t)||(t=F(a)),s=we.cssHooks[t]||we.cssHooks[a],s&&"get"in s&&(i=s.get(e,!0,n)),void 0===i&&(i=M(e,t,r)),"normal"===i&&t in dt&&(i=dt[t]),""===n||n?(o=parseFloat(i),!0===n||isFinite(o)?o||0:i):i}}),we.each(["height","width"],function(e,t){we.cssHooks[t]={get:function(e,n,r){if(n)return!pt.test(we.css(e,"display"))||e.getClientRects().length&&e.getBoundingClientRect().width?z(e,t,r):Ke(e,ht,function(){return z(e,t,r)})},set:function(e,n,r){var i,o=lt(e),s="border-box"===we.css(e,"boxSizing",!1,o),a=r&&U(e,t,r,s,o)
return s&&ve.scrollboxSize()===o.position&&(a-=Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-parseFloat(o[t])-U(e,t,"border",!1,o)-.5)),a&&(i=Ve.exec(n))&&"px"!==(i[3]||"px")&&(e.style[t]=n,n=we.css(e,t)),B(e,n,a)}}}),we.cssHooks.marginLeft=I(ve.reliableMarginLeft,function(e,t){if(t)return(parseFloat(M(e,"marginLeft"))||e.getBoundingClientRect().left-Ke(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),we.each({margin:"",padding:"",border:"Width"},function(e,t){we.cssHooks[e+t]={expand:function(n){for(var r=0,i={},o="string"==typeof n?n.split(" "):[n];r<4;r++)i[e+We[r]+t]=o[r]||o[r-2]||o[0]
return i}},"margin"!==e&&(we.cssHooks[e+t].set=B)}),we.fn.extend({css:function(e,t){return Me(this,function(e,t,n){var r,i,o={},s=0
...
we.Animation=we.extend($,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t)
return y(n.elem,e,Ve.exec(t),n),n}]},tweener:function(e,t){ye(e)?(t=e,e=["*"]):e=e.match(je)
for(var n,r=0,i=e.length;r<i;r++)n=e[r],$.tweeners[n]=$.tweeners[n]||[],$.tweeners[n].unshift(t)},prefilters:[K],prefilter:function(e,t){t?$.prefilters.unshift(e):$.prefilters.push(e)}}),we.speed=function(e,t,n){var r=e&&"object"==typeof e?we.extend({},e):{complete:n||!n&&t||ye(e)&&e,duration:e,easing:n&&t||t&&!ye(t)&&t}
return we.fx.off?r.duration=0:"number"!=typeof r.duration&&(r.duration in we.fx.speeds?r.duration=we.fx.speeds[r.duration]:r.duration=we.fx.speeds._default),null!=r.queue&&!0!==r.queue||(r.queue="fx"),r.old=r.complete,r.complete=function(){ye(r.old)&&r.old.call(this),r.queue&&we.dequeue(this,r.queue)},r},we.fn.extend({fadeTo:function(e,t,n,r){return this.filter(Ge).css("opacity",0).show().end().animate({opacity:t},e,n,r)},animate:function(e,t,n,r){var i=we.isEmptyObject(e),o=we.speed(t,n,r),s=function(){var t=$(this,we.extend({},e),o);(i||Be.get(this,"finish"))&&t.stop(!0)}
return s.finish=s,i||!1===o.queue?this.each(s):this.queue(o.queue,s)},stop:function(e,t,n){var r=function(e){var t=e.stop
delete e.stop,t(n)}
return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&!1!==e&&this.queue(e||"fx",[]),this.each(function(){var t=!0,i=null!=e&&e+"queueHooks",o=we.timers,s=Be.get(this)
if(i)s[i]&&s[i].stop&&r(s[i])
else for(i in s)s[i]&&s[i].stop&&_t.test(i)&&r(s[i])
for(i=o.length;i--;)o[i].elem!==this||null!=e&&o[i].queue!==e||(o[i].anim.stop(n),t=!1,o.splice(i,1))
!t&&n||we.dequeue(this,e)})},finish:function(e){return!1!==e&&(e=e||"fx"),this.each(function(){var t,n=Be.get(this),r=n[e+"queue"],i=n[e+"queueHooks"],o=we.timers,s=r?r.length:0
...
return t?parseInt(t,10):xt.test(e.nodeName)||Ct.test(e.nodeName)&&e.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),ve.optSelected||(we.propHooks.selected={get:function(e){var t=e.parentNode
...
else void 0!==e&&"boolean"!==n||(t=J(this),t&&Be.set(this,"__className__",t),this.setAttribute&&this.setAttribute("class",t||!1===e?"":Be.get(this,"__className__")||""))})},hasClass:function(e){var t,n,r=0
...
if(i)return(t=we.valHooks[i.type]||we.valHooks[i.nodeName.toLowerCase()])&&"get"in t&&void 0!==(n=t.get(i,"value"))?n:(n=i.value,"string"==typeof n?n.replace(Ot,""):null==n?"":n)}}}),we.extend({valHooks:{option:{get:function(e){var t=we.find.attr(e,"value")
...
return n||(e.selectedIndex=-1),o}}}}),we.each(["radio","checkbox"],function(){we.valHooks[this]={set:function(e,t){if(Array.isArray(t))return e.checked=we.inArray(we(e).val(),t)>-1}},ve.checkOn||(we.valHooks[this].get=function(e){return null===e.getAttribute("value")?"on":e.value})}),ve.focusin="onfocusin"in e
...
if(s=f=a=r=r||se,3!==r.nodeType&&8!==r.nodeType&&!At.test(d+we.event.triggered)&&(d.indexOf(".")>-1&&(m=d.split("."),d=m.shift(),m.sort()),l=d.indexOf(":")<0&&"on"+d,t=t[we.expando]?t:new we.Event(d,"object"==typeof t&&t),t.isTrigger=i?2:3,t.namespace=m.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=r),n=null==n?[t]:we.makeArray(n,[t]),p=we.event.special[d]||{},i||!p.trigger||!1!==p.trigger.apply(r,n))){if(!i&&!p.noBubble&&!be(r)){for(u=p.delegateType||d,At.test(u+d)||(s=s.parentNode);s;s=s.parentNode)h.push(s),a=s
a===(r.ownerDocument||se)&&h.push(a.defaultView||a.parentWindow||e)}for(o=0;(s=h[o++])&&!t.isPropagationStopped();)f=s,t.type=o>1?u:p.bindType||d,c=(Be.get(s,"events")||{})[t.type]&&Be.get(s,"handle"),c&&c.apply(s,n),(c=l&&s[l])&&c.apply&&Fe(s)&&(t.result=c.apply(s,n),!1===t.result&&t.preventDefault())
...
we.event.special[t]={setup:function(){var r=this.ownerDocument||this,i=Be.access(r,t)
...
var Tt=e.location,Rt=Date.now(),kt=/\?/
...
return this.name&&!we(this).is(":disabled")&&Dt.test(this.nodeName)&&!Pt.test(e)&&(this.checked||!$e.test(e))}).map(function(e,t){var n=we(this).val()
return null==n?null:Array.isArray(n)?we.map(n,function(e){return{name:t.name,value:e.replace(jt,"\r\n")}}):{name:t.name,value:n.replace(jt,"\r\n")}}).get()}})
var Mt=/%20/g,It=/#.*$/,Lt=/([?&])_=[^&]*/,Ft=/^(.*?):[ \t]*([^\r\n]*)$/gm,Bt=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Ut=/^(?:GET|HEAD)$/,zt=/^\/\//,Ht={},qt={},Vt="*/".concat("*"),Wt=se.createElement("a")
Wt.href=Tt.href,we.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Tt.href,type:"GET",isLocal:Bt.test(Tt.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Vt,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":we.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?ne(ne(e,we.ajaxSettings),t):ne(we.ajaxSettings,e)},ajaxPrefilter:ee(Ht),ajaxTransport:ee(qt),ajax:function(t,n){function r(t,n,r,a){var l,f,h,_,w,E=n
c||(c=!0,u&&e.clearTimeout(u),i=void 0,s=a||"",x.readyState=t>0?4:0,l=t>=200&&t<300||304===t,r&&(_=re(d,x,r)),_=ie(d,_,x,l),l?(d.ifModified&&(w=x.getResponseHeader("Last-Modified"),w&&(we.lastModified[o]=w),(w=x.getResponseHeader("etag"))&&(we.etag[o]=w)),204===t||"HEAD"===d.type?E="nocontent":304===t?E="notmodified":(E=_.state,f=_.data,h=_.error,l=!h)):(h=E,!t&&E||(E="error",t<0&&(t=0))),x.status=t,x.statusText=(n||E)+"",l?v.resolveWith(m,[f,E,x]):v.rejectWith(m,[x,E,h]),x.statusCode(b),b=void 0,p&&g.trigger(l?"ajaxSuccess":"ajaxError",[x,d,l?f:h]),y.fireWith(m,[x,E]),p&&(g.trigger("ajaxComplete",[x,d]),--we.active||we.event.trigger("ajaxStop")))}"object"==typeof t&&(n=t,t=void 0),n=n||{}
var i,o,s,a,u,l,c,p,f,h,d=we.ajaxSetup({},n),m=d.context||d,g=d.context&&(m.nodeType||m.jquery)?we(m):we.event,v=we.Deferred(),y=we.Callbacks("once memory"),b=d.statusCode||{},_={},w={},E="canceled",x={readyState:0,getResponseHeader:function(e){var t
...
if(v.promise(x),d.url=((t||d.url||Tt.href)+"").replace(zt,Tt.protocol+"//"),d.type=n.method||n.type||d.method||d.type,d.dataTypes=(d.dataType||"*").toLowerCase().match(je)||[""],null==d.crossDomain){l=se.createElement("a")
try{l.href=d.url,l.href=l.href,d.crossDomain=Wt.protocol+"//"+Wt.host!=l.protocol+"//"+l.host}catch(e){d.crossDomain=!0}}if(d.data&&d.processData&&"string"!=typeof d.data&&(d.data=we.param(d.data,d.traditional)),te(Ht,d,n,x),c)return x
p=we.event&&d.global,p&&0==we.active++&&we.event.trigger("ajaxStart"),d.type=d.type.toUpperCase(),d.hasContent=!Ut.test(d.type),o=d.url.replace(It,""),d.hasContent?d.data&&d.processData&&0===(d.contentType||"").indexOf("application/x-www-form-urlencoded")&&(d.data=d.data.replace(Mt,"+")):(h=d.url.slice(o.length),d.data&&(d.processData||"string"==typeof d.data)&&(o+=(kt.test(o)?"&":"?")+d.data,delete d.data),!1===d.cache&&(o=o.replace(Lt,"$1"),h=(kt.test(o)?"&":"?")+"_="+Rt+++h),d.url=o+h),d.ifModified&&(we.lastModified[o]&&x.setRequestHeader("If-Modified-Since",we.lastModified[o]),we.etag[o]&&x.setRequestHeader("If-None-Match",we.etag[o])),(d.data&&d.hasContent&&!1!==d.contentType||n.contentType)&&x.setRequestHeader("Content-Type",d.contentType),x.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+Vt+"; q=0.01":""):d.accepts["*"])
for(f in d.headers)x.setRequestHeader(f,d.headers[f])
if(d.beforeSend&&(!1===d.beforeSend.call(m,x,d)||c))return x.abort()
if(E="abort",y.add(d.complete),x.done(d.success),x.fail(d.error),i=te(qt,d,n,x)){if(x.readyState=1,p&&g.trigger("ajaxSend",[x,d]),c)return x
...
ve.cors=!!Kt&&"withCredentials"in Kt,ve.ajax=Kt=!!Kt,we.ajaxTransport(function(t){var n,r
...
var Qt=[],$t=/(=)\?(?=&|$)|\?\?/
we.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=Qt.pop()||we.expando+"_"+Rt++
return this[e]=!0,e}}),we.ajaxPrefilter("json jsonp",function(t,n,r){var i,o,s,a=!1!==t.jsonp&&($t.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&$t.test(t.data)&&"data")
if(a||"jsonp"===t.dataTypes[0])return i=t.jsonpCallback=ye(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace($t,"$1"+i):!1!==t.jsonp&&(t.url+=(kt.test(t.url)?"&":"?")+t.jsonp+"="+i),t.converters["script json"]=function(){return s||we.error(i+" was not called"),s[0]},t.dataTypes[0]="json",o=e[i],e[i]=function(){s=arguments},r.always(function(){void 0===o?we(e).removeProp(i):e[i]=o,t[i]&&(t.jsonpCallback=n.jsonpCallback,Qt.push(i)),s&&ye(o)&&o(s[0]),s=o=void 0}),"script"}),ve.createHTMLDocument=function(){var e=se.implementation.createHTMLDocument("").body
return e.innerHTML="<form></form><form></form>",2===e.childNodes.length}(),we.parseHTML=function(e,t,n){if("string"!=typeof e)return[]
"boolean"==typeof t&&(n=t,t=!1)
var r,i,o
return t||(ve.createHTMLDocument?(t=se.implementation.createHTMLDocument(""),r=t.createElement("base"),r.href=se.location.href,t.head.appendChild(r)):t=se),i=Se.exec(e),o=!n&&[],i?[t.createElement(i[1])]:(i=x([e],t,o),o&&o.length&&we(o).remove(),we.merge([],i.childNodes))},we.fn.load=function(e,t,n){var r,i,o,s=this,a=e.indexOf(" ")
...
o?o.scrollTo(n?o.pageXOffset:i,n?i:o.pageYOffset):e[r]=i},e,r,arguments.length)}}),we.each(["top","left"],function(e,t){we.cssHooks[t]=I(ve.pixelPosition,function(e,n){if(n)return n=M(e,t),ut.test(n)?we(e).position()[t]+"px":n})}),we.each({Height:"height",Width:"width"},function(e,t){we.each({padding:"inner"+e,content:t,"":"outer"+e},function(n,r){we.fn[r]=function(i,o){var s=arguments.length&&(n||"boolean"!=typeof i),a=n||(!0===i||!0===o?"margin":"border")
...
return we.noConflict=function(t){return e.$===we&&(e.$=Jt),t&&e.jQuery===we&&(e.jQuery=Yt),we},t||(e.jQuery=e.$=we),we}),function(){var e,t,n,r=this;(function(){function r(e,t){throw t?new Error("Could not find module "+e+" required by: "+t):new Error("Could not find module "+e)}function i(e,n){var a=e,u=o[a]
u||(a+="/index",u=o[a])
var l=s[a]
...
return"this"===r[0]&&(r[0]=null),D(r,t).evaluate(e)}}function T(e,t){return Array.isArray(e)?mn.compile(e,t):new wt(e)}function R(e,t,n){var r=j(e,n),i=P(t,n)
return qe.create(r,i,He)}function k(e,t,n,r){var i=j(e,r),o=P(t,r)
return qe.create(i,o,n)}function N(e,t){var n=e[0],r=e[1],i=e[2],o=e[3]
return qe.create(j(n,t),P(r,t),{default:i,inverse:o})}function j(e,t){if(!e||0===e.length)return Me
var n,r=new Array(e.length)
for(n=0;n<e.length;n++)r[n]=T(e[n],t)
return De.create(r)}function P(e,t){if(!e)return Be
var n,r=e[0],i=e[1]
...
return t}}]),e}(),ze=new(function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.call(this,je,je,Pe))}return(0,t.inherits)(n,e),n.prototype.get=function(){return me},n.prototype.has=function(){return!1},n.prototype.value=function(){return Pe},n}(Ue)),He={default:null,inverse:null},qe=function(){function e(e,t,n){this.positional=e,this.named=t,this.blocks=n,this.type="compiled-args"}return e.create=function(e,t,n){return e===Me&&t===Be&&n===He?this.empty():new this(e,t,n)},e.empty=function(){return Ve},e.prototype.evaluate=function(e){var t=this.positional,n=this.named,r=this.blocks
...
i=new Ot(r,t)}this.openBlock(e,i),this.closeBlock()},n.prototype.labelled=function(e,t){e&&this.putArgs(e),this.startLabels(),this.enter("BEGIN","END"),this.label("BEGIN"),t(this,"BEGIN","END"),this.label("END"),this.exit(),this.stopLabels()},n.prototype.iter=function(e){this.startLabels(),this.enterList("BEGIN","END"),this.label("ITER"),this.nextIter("BREAK"),this.enterWithKey("BEGIN","END"),this.label("BEGIN"),e(this,"BEGIN","END"),this.label("END"),this.exit(),this.jump("ITER"),this.label("BREAK"),this.exitList(),this.stopLabels()},n.prototype.unit=function(e){this.startLabels(),e(this),this.stopLabels()},n}(Rt),Nt=function(){function e(e){this.env=e}return e.prototype.wrapLayout=function(e){this.inner=new jt(this.env,e)},e.prototype.fromLayout=function(e){this.inner=new Pt(this.env,e)},e.prototype.compile=function(){return this.inner.compile()},(0,t.createClass)(e,[{key:"tag",get:function(){return this.inner.tag}},{key:"attrs",get:function(){return this.inner.attrs}}]),e}(),jt=function(){function e(e,t){this.env=e,this.layout=t,this.tag=new Dt,this.attrs=new Mt}return e.prototype.compile=function(){var e=this.env,t=this.layout,n=t.symbolTable,r=y(e,t.symbolTable)
r.startLabels()
var i=this.tag.getDynamic(),o=void 0
return i?(r.putValue(i),r.test("simple"),r.jumpUnless("BODY"),r.openDynamicPrimitiveElement(),r.didCreateElement(),this.attrs.buffer.forEach(function(e){return x(e,r)}),r.flushElement(),r.label("BODY")):(o=this.tag.getStatic())&&(r.openPrimitiveElement(o),r.didCreateElement(),this.attrs.buffer.forEach(function(e){return x(e,r)}),r.flushElement()),r.preludeForLayout(t),t.statements.forEach(function(e){return x(e,r)}),i?(r.putValue(i),r.test("simple"),r.jumpUnless("END"),r.closeElement(),r.label("END")):o&&r.closeElement(),r.didRenderLayout(),r.stopLabels(),new St(r.start,r.end,n.size)},e}(),Pt=function(){function e(e,t){this.env=e,this.layout=t,this.attrs=new Mt}return e.prototype.compile=function(){var e,t,n=this.env,r=this.layout,i=y(n,r.symbolTable)
...
return i.didRenderLayout(),i.stopLabels(),new St(i.start,i.end,r.symbolTable.size)},(0,t.createClass)(e,[{key:"tag",get:function(){throw new Error("BUG: Cannot call `tag` on an UnwrappedBuilder")}}]),e}(),Dt=function(){function e(){this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}return e.prototype.getDynamic=function(){if(this.isDynamic)return this.dynamicTagName},e.prototype.getStatic=function(){if(this.isStatic)return this.staticTagName},e.prototype.static=function(e){this.isStatic=!0,this.staticTagName=e},e.prototype.dynamic=function(e){this.isDynamic=!0,this.dynamicTagName=[i.Ops.Function,e]},e}(),Mt=function(){function e(){this.buffer=[]}return e.prototype.static=function(e,t){this.buffer.push([i.Ops.StaticAttr,e,t,null])},e.prototype.dynamic=function(e,t){this.buffer.push([i.Ops.DynamicAttr,e,[i.Ops.Function,t],null])},e}(),It=function(){function e(e){this.builder=e,this.env=e.env}return e.prototype.static=function(e,t,n,r){this.builder.unit(function(n){n.putComponentDefinition(e),n.openComponent(N(t,n),r),n.closeComponent()})},e.prototype.dynamic=function(e,t,n,r,o){this.builder.unit(function(r){r.putArgs(R(e[0],e[1],r)),r.putValue([i.Ops.Function,t]),r.test("simple"),r.enter("BEGIN","END"),r.label("BEGIN"),r.jumpUnless("END"),r.putDynamicComponentDefinition(),r.openComponent(N(n,r),o),r.closeComponent(),r.label("END"),r.exit()})},e}(),Lt=function(){function e(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:1
...
return e.name?"`"+e.name+"(...)`":"`func(...)`"},n}(it),an=qt.NestedBlock,un=an.defaultBlock,ln=an.params,cn=an.hash,pn=A,fn=function(){function e(){this.names=(0,n.dict)(),this.funcs=[]}return e.prototype.add=function(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1},e.prototype.compile=function(e,t){var r=e[0],i=this.names[r],o=this.funcs[i]
...
var n=t
n=$(Nn,n),n=q(Nn,n),n=G(Nn,n,An),e.DOMTreeConstruction=n})(Rn||(Rn={}))
...
return this.insertBefore(e,r,t),r},e.prototype.insertBefore=function(e,t,n){e.insertBefore(t,n)},e.prototype.insertAfter=function(e,t,n){this.insertBefore(e,t,n.nextSibling)},e}(),Pn=jn
...
var s=e.prototype.insertHTMLBefore.call(this,t,n,r)
return i&&t.removeChild(this.uselessComment),s},n}(n):n}(Nn,Pn),Pn=function(e,n){if(!e)return n
if(!W(e))return n
var r=e.createElement("div")
...
var o=t.tagName.toLowerCase(),s=On[o]
return void 0===s?e.prototype.insertHTMLBefore.call(this,t,n,i):V(t,s,r,i,n)},n}(n)}(Nn,Pn),Pn=function(e,n,r){if(!e)return n
if(!Q(e,r))return n
var i=e.createElement("div")
return function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.insertHTMLBefore=function(t,n,o){return null===o||""===o?e.prototype.insertHTMLBefore.call(this,t,n,o):t.namespaceURI!==r?e.prototype.insertHTMLBefore.call(this,t,n,o):K(t,i,o,n)},n}(n)}(Nn,Pn,An)
var Dn=Pn,Mn=Rn.DOMTreeConstruction,In=function(){function e(e){this.attr=e}return e.prototype.setAttribute=function(e,t,n,r){var i=e.getAppendOperations(),o=re(n)
...
r&&r.revalidate(t)}function N(){Pt++}function j(){--Pt<=0&&(Nt.clear(),jt.flush())}function P(e,t){N()
try{e.call(t)}finally{j.call(t)}}function D(e,t,n){if(!n.isSourceDestroying()){var r=t+":before",i=void 0,o=void 0
Pt?(i=Nt.add(e,t,r),o=p(e,r,i),g(e,r,[e,t],o)):g(e,r,[e,t])}}function M(e,t,n){if(!n.isSourceDestroying()){var r=t+":change",i=void 0
Pt?(i=jt.add(e,t,r),p(e,r,i)):g(e,r,[e,t])}}function I(){this.isDescriptor=!0}function L(e,t,n,r,i){i||(i=ie(e))
...
for(e+=t.substring(0,n),a=u.length;o<a;)s=l.indexOf("{"),s<0?r((e+u[o++]+l).replace(on,".[]")):ge(e+u[o++],l,s,r)}function ve(e,t,n){se(t)?q(e,t,n):B(e,t,n)}function ye(e,t,n){se(t)?V(e,t,n):U(e,t,n)}function be(e,t,n,r){var i=void 0,o=void 0,s=e._dependentKeys
...
hn?hn(e):a.error(fn(e))}function je(e){return"object"==typeof e&&null!==e||"function"==typeof e}function Pe(e){var t,r,i,o
...
var kt=n.symbol("PROPERTY_DID_CHANGE"),Nt=new Rt,jt=new Rt,Pt=0,Dt=void 0,Mt=void 0;(function(){var e=Object.create(Object.prototype,{prop:{configurable:!0,value:1}})
...
t.prototype["writable"+r]=function(e){var t=this[n]
return void 0===t&&(t=this.parent?this[n]=this.parent["writable"+r](e).copy(this.source):this[n]=e(this.source)),t},t.prototype["readable"+r]=function(){return this._getInherited(n)}},tag:ee,tags:X},zt=Object.keys(Ut),Ht=function(){function t(e,t){this._cache=void 0,this._weak=void 0,this._watching=void 0,this._mixins=void 0,this._bindings=void 0,this._values=void 0,this._deps=void 0,this._chainWatchers=void 0,this._chains=void 0,this._tag=void 0,this._tags=void 0,this._factory=void 0,this._flags=0,this.source=e,this.proto=void 0,this.parent=t,this._initializeListeners()}return t.prototype.isInitialized=function(e){return this.proto!==e},t.prototype.setTag=function(e){this._tag=e},t.prototype.getTag=function(){return this._tag},t.prototype.destroy=function(){if(!this.isMetaDestroyed()){var t,n=void 0,r=void 0,i=void 0,o=this.readableChains()
...
zt.forEach(function(e){return Ut[e](e,Ht)})
...
Pe.prototype.get=function(t){if(je(t)){var n,r=e.peekMeta(t)
if(r&&(n=r.readableWeak())){if(n[this._id]===Wt)return
return n[this._id]}}},Pe.prototype.set=function(e,t){if(!je(e))throw new TypeError("Invalid value used as weak map key")
return void 0===t&&(t=Wt),ie(e).writableWeak()[this._id]=t,this},Pe.prototype.has=function(t){if(!je(t))return!1
...
var gn={get onerror(){return ke},set onerror(e){return Re(e)}},vn=new u(["sync","actions","destroy"],{GUID_KEY:n.GUID_KEY,sync:{before:N,after:j},defaultQueue:"actions",onBegin:function(e){Le.currentRunLoop=e},onEnd:function(e,t){Le.currentRunLoop=t},onErrorTarget:gn,onErrorMethod:"onerror"})
...
var Sn=new I
Sn.toString=function(){return"(Required Property)"},gt.prototype=new I,yt.prototype=Object.create(I.prototype)
...
return r&&r.peekWatching(n)||0},e.libraries=bn,e.Libraries=yn,e.Map=qe,e.MapWithDefault=Ve,e.OrderedSet=He,e.getProperties=function(e){var t={},n=arguments,r=1
...
Object.defineProperty(e,"max",{enumerable:!0,get:function(){return R.max}}),Object.defineProperty(e,"map",{enumerable:!0,get:function(){return R.map}}),Object.defineProperty(e,"sort",{enumerable:!0,get:function(){return R.sort}}),Object.defineProperty(e,"setDiff",{enumerable:!0,get:function(){return R.setDiff}}),Object.defineProperty(e,"mapBy",{enumerable:!0,get:function(){return R.mapBy}}),Object.defineProperty(e,"filter",{enumerable:!0,get:function(){return R.filter}}),Object.defineProperty(e,"filterBy",{enumerable:!0,get:function(){return R.filterBy}}),Object.defineProperty(e,"uniq",{enumerable:!0,get:function(){return R.uniq}}),Object.defineProperty(e,"uniqBy",{enumerable:!0,get:function(){return R.uniqBy}}),Object.defineProperty(e,"union",{enumerable:!0,get:function(){return R.union}}),Object.defineProperty(e,"intersect",{enumerable:!0,get:function(){return R.intersect}}),Object.defineProperty(e,"collect",{enumerable:!0,get:function(){return R.collect}}),Object.defineProperty(e,"Controller",{enumerable:!0,get:function(){return k.default}}),Object.defineProperty(e,"ControllerMixin",{enumerable:!0,get:function(){return N.default}}),Object.defineProperty(e,"Service",{enumerable:!0,get:function(){return j.default}}),Object.defineProperty(e,"RSVP",{enumerable:!0,get:function(){return P.default}}),Object.defineProperty(e,"onerrorDefault",{enumerable:!0,get:function(){return P.onerrorDefault}}),Object.defineProperty(e,"isArray",{enumerable:!0,get:function(){return D.isArray}}),Object.defineProperty(e,"typeOf",{enumerable:!0,get:function(){return D.typeOf}}),Object.defineProperty(e,"getStrings",{enumerable:!0,get:function(){return M.getStrings}}),Object.defineProperty(e,"setStrings",{enumerable:!0,get:function(){return M.setStrings}})}),e("ember-runtime/inject",["exports","ember-metal","ember-debug"],function(e,t,n){"use strict"
...
for(g.length=f.length,r=0;r<f.length;r++){if(i=f[r],o=i.names,s=i.shouldDecodes,a=S,u=!1,o!==T&&s!==T)for(l=0;l<o.length;l++)u=!0,c=o[l],p=d&&d[m++],a===S&&(a={}),N.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[l]?a[c]=p&&decodeURIComponent(p):a[c]=p
...
return o}function N(e,t,n){return e===Ae?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}function j(e,t,n,r){this._instanceConstructor=e,this.promise=new e(d,r),this._abortOnReject=n,this._validateInput(t)?(this._input=t,this.length=t.length,this._remaining=t.length,this._init(),0===this.length?E(this.promise,this._result):(this.length=this.length||0,this._enumerate(),0===this._remaining&&E(this.promise,this._result))):x(this.promise,this._validationError())}function P(e,t){return new j(this,e,!0,t).promise}function D(e,t){var n=this,r=new n(d,t)
...
return x(u,Pe.value),u}o&&!0!==o&&(a=V(o,a))}i[s]=a}var l=new F(d)
return i[r]=function(e,t){e?x(l,e):void 0===n?_(l,t):!0===n?_(l,q(arguments)):we(n)?_(l,H(arguments,n)):_(l,t)},o?K(l,i,e,t):G(l,i,e,t)}
...
return i===je&&x(e,i.value),e})}function Q(e){return!(!e||"object"!=typeof e)&&(e.constructor===F||U(e))}function $(e,t){return F.all(e,t)}function Y(e,t,n){this._superConstructor(e,t,!1,n)}function J(e,t){return new Y(F,e,t).promise}function X(e,t){return F.race(e,t)}function Z(e,t,n){this._superConstructor(e,t,!0,n)}function ee(e,t){return new Z(F,e,t).promise}function te(e,t,n){this._superConstructor(e,t,!1,n)}function ne(e,t){return new te(F,e,t).promise}function re(e){throw setTimeout(function(){throw e}),e}function ie(e){var t={resolve:void 0,reject:void 0}
...
F.cast=f,F.all=P,F.race=D,F.resolve=f,F.reject=M,F.prototype={constructor:F,_guidKey:ke,_onError:function(e){var t=this
...
e.asap=pe,e.cast=qe,e.Promise=F,e.EventTarget=ye,e.all=$,e.allSettled=J,e.race=X,e.hash=ee,e.hashSettled=ne,e.rethrow=re,e.defer=ie,e.denodeify=W,e.configure=o,e.on=me,e.off=ge,e.resolve=se,e.reject=ae,e.map=oe,e.async=Ve,e.filter=ce,e.default=Ke})
...
return n&&0===n.index}function i(e){return A.test(e)}function o(e){var t,n,r,o,s=e.className+" "
if(s+=e.parentNode?e.parentNode.className:"",n=S.exec(s))return w(n[1])?n[1]:"no-highlight"
for(s=s.split(/\s+/),t=0,r=s.length;r>t;t++)if(o=s[t],i(o)||w(o))return o}function s(e){var t,n={},r=Array.prototype.slice.call(arguments,1)
for(t in e)n[t]=e[t]
...
return i}(e,0),t}function u(e,r,i){function o(){return e.length&&r.length?e[0].offset!==r[0].offset?e[0].offset<r[0].offset?e:r:"start"===r[0].event?e:r:e.length?e:r}function s(e){function r(e){return" "+e.nodeName+'="'+t(e.value).replace('"',"&quot;")+'"'}c+="<"+n(e)+E.map.call(e.attributes,r).join("")+">"}function a(e){c+="</"+n(e)+">"}function u(e){("start"===e.event?s:a)(e.node)}for(var l=0,c="",p=[];e.length||r.length;){var f=o()
...
"string"==typeof i.k?a("keyword",i.k):x(i.k).forEach(function(e){a(e,i.k[e])}),i.k=s}i.lR=n(i.l||/\w+/,!0),o&&(i.bK&&(i.b="\\b("+i.bK.split(" ").join("|")+")\\b"),i.b||(i.b=/\B|\b/),i.bR=n(i.b),i.e||i.eW||(i.e=/\B|\b/),i.e&&(i.eR=n(i.e)),i.tE=t(i.e)||"",i.eW&&o.tE&&(i.tE+=(i.e?"|":"")+o.tE)),i.i&&(i.iR=n(i.i)),null==i.r&&(i.r=1),i.c||(i.c=[]),i.c=Array.prototype.concat.apply([],i.c.map(function(e){return l("self"===e?i:e)})),i.c.forEach(function(e){r(e,i)}),i.starts&&r(i.starts,o)
...
return e}return e.eW?a(e.parent,t):void 0}function u(e,t){return!i&&r(t.iR,e)}function l(e,t){var n=b.cI?t[0].toLowerCase():t[0]
return e.k.hasOwnProperty(n)&&e.k[n]}function h(e,t,n,r){var i=r?"":k.classPrefix,o='<span class="'+i,s=n?"":R
return(o+=e+'">')+t+s}function d(){var e,n,r,i
if(!E.k)return t(A)
for(i="",n=0,E.lR.lastIndex=0,r=E.lR.exec(A);r;)i+=t(A.substring(n,r.index)),e=l(E,r),e?(S+=e[1],i+=h(e[0],t(r[0]))):i+=t(r[0]),n=E.lR.lastIndex,r=E.lR.exec(A)
return i+t(A.substr(n))}function m(){var e="string"==typeof E.sL
if(e&&!C[E.sL])return t(A)
var n=e?p(E.sL,A,!0,x[E.sL]):f(A,E.sL.length?E.sL:void 0)
return E.r>0&&(S+=n.r),e&&(x[E.sL]=n.top),h(n.language,n.value,!1,!0)}function g(){O+=null!=E.sL?m():d(),A=""}function v(e){O+=e.cN?h(e.cN,"",!0):"",E=Object.create(e,{parent:{value:E}})}function y(e,t){if(A+=e,null==t)return g(),0
var n=s(t,E)
if(n)return n.skip?A+=t:(n.eB&&(A+=t),g(),n.rB||n.eB||(A=t)),v(n,t),n.rB?0:t.length
var r=a(E,t)
if(r){var i=E
i.skip?A+=t:(i.rE||i.eE||(A+=t),g(),i.eE&&(A=t))
do{E.cN&&(O+=R),E.skip||(S+=E.r),E=E.parent}while(E!==r.parent)
return r.starts&&v(r.starts,""),i.rE?0:t.length}if(u(t,E))throw new Error('Illegal lexeme "'+t+'" for mode "'+(E.cN||"<unnamed>")+'"')
return A+=t,t.length||1}var b=w(e)
if(!b)throw new Error('Unknown language: "'+e+'"')
c(b)
var _,E=o||b,x={},O=""
for(_=E;_!==b;_=_.parent)_.cN&&(O=h(_.cN,"",!0)+O)
var A="",S=0
try{for(var T,N,j=0;E.t.lastIndex=j,T=E.t.exec(n);)N=y(n.substring(j,T.index),T[0]),j=T.index+N
for(y(n.substr(j)),_=E;_.parent;_=_.parent)_.cN&&(O+=R)
return{r:S,value:O,language:e,top:E}}catch(e){if(e.message&&-1!==e.message.indexOf("Illegal"))return{r:0,value:t(n)}
throw e}}function f(e,n){n=n||k.languages||x(C)
var r={r:0,value:t(e)},i=r
return n.filter(w).forEach(function(t){var n=p(t,e,!1)
n.language=t,n.r>i.r&&(i=n),n.r>r.r&&(i=r,r=n)}),i.language&&(r.second_best=i),r}function h(e){return k.tabReplace||k.useBR?e.replace(T,function(e,t){return k.useBR&&"\n"===e?"<br>":k.tabReplace?t.replace(/\t/g,k.tabReplace):""}):e}function d(e,t,n){var r=t?O[t]:n,i=[e.trim()]
return e.match(/\bhljs\b/)||i.push("hljs"),-1===e.indexOf(r)&&i.push(r),i.join(" ").trim()}function m(e){var t,n,r,s,l,c=o(e)
i(c)||(k.useBR?(t=document.createElementNS("http://www.w3.org/1999/xhtml","div"),t.innerHTML=e.innerHTML.replace(/\n/g,"").replace(/<br[ \/]*>/g,"\n")):t=e,l=t.textContent,r=c?p(c,l,!0):f(l),n=a(t),n.length&&(s=document.createElementNS("http://www.w3.org/1999/xhtml","div"),s.innerHTML=r.value,r.value=u(n,a(s),l)),r.value=h(r.value),e.innerHTML=r.value,e.className=d(e.className,c,r.language),e.result={language:r.language,re:r.r},r.second_best&&(e.second_best={language:r.second_best.language,re:r.second_best.r}))}function g(e){k=s(k,e)}function v(){if(!v.called){v.called=!0
var e=document.querySelectorAll("pre code")
E.forEach.call(e,m)}}function y(){addEventListener("DOMContentLoaded",v,!1),addEventListener("load",v,!1)}function b(t,n){var r=C[t]=n(e)
r.aliases&&r.aliases.forEach(function(e){O[e]=t})}function _(){return x(C)}function w(e){return e=(e||"").toLowerCase(),C[e]||C[O[e]]}var E=[],x=Object.keys,C={},O={},A=/^(no-?highlight|plain|text)$/i,S=/\blang(?:uage)?-([\w-]+)\b/i,T=/((^(<[^>]+>|\t|)+|(?:\n)))/gm,R="</span>",k={classPrefix:"hljs-",tabReplace:null,useBR:!1,languages:void 0}
return e.highlight=p,e.highlightAuto=f,e.fixMarkup=h,e.highlightBlock=m,e.configure=g,e.initHighlighting=v,e.initHighlightingOnLoad=y,e.registerLanguage=b,e.listLanguages=_,e.getLanguage=w,e.inherit=s,e.IR="[a-zA-Z]\\w*",e.UIR="[a-zA-Z_]\\w*",e.NR="\\b\\d+(\\.\\d+)?",e.CNR="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",e.BNR="\\b(0b[01]+)",e.RSR="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",e.BE={b:"\\\\[\\s\\S]",r:0},e.ASM={cN:"string",b:"'",e:"'",i:"\\n",c:[e.BE]},e.QSM={cN:"string",b:'"',e:'"',i:"\\n",c:[e.BE]},e.PWM={b:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},e.C=function(t,n,r){var i=e.inherit({cN:"comment",b:t,e:n,c:[]},r||{})
...
return e.unshift("highlight.js"),define.apply(null,e)}return e.amd=!0,e}()),createDeprecatedModule("ember/resolver"),createDeprecatedModule("resolver"),function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.Tether=t()}(this,function(){"use strict"
function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e){var n=e.getBoundingClientRect(),r={}
for(var i in n)r[i]=n[i]
if(e.ownerDocument!==document){var o=e.ownerDocument.defaultView.frameElement
if(o){var s=t(o)
r.top+=s.top,r.bottom+=s.top,r.left+=s.left,r.right+=s.left}}return r}function n(e){var t=getComputedStyle(e)||{},n=t.position,r=[]
if("fixed"===n)return[e]
...
var s=o,a=s.overflow,u=s.overflowX;/(auto|scroll|overlay)/.test(a+s.overflowY+u)&&("absolute"!==n||["relative","absolute","fixed"].indexOf(o.position)>=0)&&r.push(i)}return r.push(e.ownerDocument.body),e.ownerDocument!==document&&r.push(e.ownerDocument.defaultView),r}function r(){E&&document.body.removeChild(E),E=null}function i(e){var n=void 0
e===document?(n=document,e=document.documentElement):n=e.ownerDocument
var r=n.documentElement,i=t(e),o=O()
return i.top-=o.top,i.left-=o.left,void 0===i.width&&(i.width=document.body.scrollWidth-i.left-i.right),void 0===i.height&&(i.height=document.body.scrollHeight-i.top-i.bottom),i.top=i.top-r.clientTop,i.left=i.left-r.clientLeft,i.right=n.body.clientWidth-i.width-i.left,i.bottom=n.body.clientHeight-i.height-i.top,i}function o(e){return e.offsetParent||document.documentElement}function s(){if(A)return A
var e=document.createElement("div")
e.style.width="100%",e.style.height="200px"
var t=document.createElement("div")
a(t.style,{position:"absolute",top:0,left:0,pointerEvents:"none",visibility:"hidden",width:"200px",height:"150px",overflow:"hidden"}),t.appendChild(e),document.body.appendChild(t)
var n=e.offsetWidth
t.style.overflow="scroll"
var r=e.offsetWidth
n===r&&(r=t.clientWidth),document.body.removeChild(t)
var i=n-r
return A={width:i,height:i}}function a(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],t=[]
return Array.prototype.push.apply(t,arguments),t.slice(1).forEach(function(t){if(t)for(var n in t)({}).hasOwnProperty.call(t,n)&&(e[n]=t[n])}),e}function u(e,t){if(void 0!==e.classList)t.split(" ").forEach(function(t){t.trim()&&e.classList.remove(t)})
else{var n=new RegExp("(^| )"+t.split(" ").join("|")+"( |$)","gi"),r=p(e).replace(n," ")
f(e,r)}}function l(e,t){if(void 0!==e.classList)t.split(" ").forEach(function(t){t.trim()&&e.classList.add(t)})
else{u(e,t)
var n=p(e)+" "+t
f(e,n)}}function c(e,t){if(void 0!==e.classList)return e.classList.contains(t)
var n=p(e)
return new RegExp("(^| )"+t+"( |$)","gi").test(n)}function p(e){return e.className instanceof e.ownerDocument.defaultView.SVGAnimatedString?e.className.baseVal:e.className}function f(e,t){e.setAttribute("class",t)}function h(e,t,n){n.forEach(function(n){-1===t.indexOf(n)&&c(e,n)&&u(e,n)}),t.forEach(function(t){c(e,t)||l(e,t)})}function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function d(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function m(e,t){var n=arguments.length<=2||void 0===arguments[2]?1:arguments[2]
return e+n>=t&&t>=e-n}function g(){return"object"==typeof performance&&"function"==typeof performance.now?performance.now():+new Date}function v(){for(var e={top:0,left:0},t=arguments.length,n=Array(t),r=0;r<t;r++)n[r]=arguments[r]
return n.forEach(function(t){var n=t.top,r=t.left
"string"==typeof n&&(n=parseFloat(n,10)),"string"==typeof r&&(r=parseFloat(r,10)),e.top+=n,e.left+=r}),e}function y(e,t){return"string"==typeof e.left&&-1!==e.left.indexOf("%")&&(e.left=parseFloat(e.left,10)/100*t.width),"string"==typeof e.top&&-1!==e.top.indexOf("%")&&(e.top=parseFloat(e.top,10)/100*t.height),e}function b(e,t){return"scrollParent"===t?t=e.scrollParents[0]:"window"===t&&(t=[pageXOffset,pageYOffset,innerWidth+pageXOffset,innerHeight+pageYOffset]),t===document&&(t=t.documentElement),void 0!==t.nodeType&&function(){var e=t,n=i(t),r=n,o=getComputedStyle(t)
if(t=[r.left,r.top,n.width+r.left,n.height+r.top],e.ownerDocument!==document){var s=e.ownerDocument.defaultView
t[0]+=s.pageXOffset,t[1]+=s.pageYOffset,t[2]+=s.pageXOffset,t[3]+=s.pageYOffset}G.forEach(function(e,n){e=e[0].toUpperCase()+e.substr(1),"Top"===e||"Left"===e?t[n]+=parseFloat(o["border"+e+"Width"]):t[n]-=parseFloat(o["border"+e+"Width"])})}(),t}var _=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),w=void 0
void 0===w&&(w={modules:[]})
var E=null,x=function(){var e=0
return function(){return++e}}(),C={},O=function(){var e=E
e&&document.body.contains(e)||(e=document.createElement("div"),e.setAttribute("data-tether-id",x()),a(e.style,{top:0,left:0,position:"absolute"}),document.body.appendChild(e),E=e)
var n=e.getAttribute("data-tether-id")
return void 0===C[n]&&(C[n]=t(e),T(function(){delete C[n]})),C[n]},A=null,S=[],T=function(e){S.push(e)},R=function(){for(var e=void 0;e=S.pop();)e()},k=function(){function t(){e(this,t)}return _(t,[{key:"on",value:function(e,t,n){var r=!(arguments.length<=3||void 0===arguments[3])&&arguments[3]
...
void 0===l&&(l=this),s.apply(l,r),u?this.bindings[e].splice(t,1):++t}}}}]),t}()
w.Utils={getActualBoundingClientRect:t,getScrollParents:n,getBounds:i,getOffsetParent:o,extend:a,addClass:l,removeClass:u,hasClass:c,updateClasses:h,defer:T,flush:R,uniqueId:x,Evented:k,getScrollBarSize:s,removeUtilElements:r}
...
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),j=function(e,t,n){for(var r=!0;r;){var i=e,o=t,s=n
...
var P=w.Utils,n=P.getScrollParents,i=P.getBounds,o=P.getOffsetParent,a=P.extend,l=P.addClass,u=P.removeClass,h=P.updateClasses,T=P.defer,R=P.flush,s=P.getScrollBarSize,r=P.removeUtilElements,D=function(){if("undefined"==typeof document)return""
...
if(void 0!==e.style[r])return r}}(),M=[],I=function(){M.forEach(function(e){e.position(!1)}),R()};(function(){var e=null,t=null,n=null,r=function r(){if(void 0!==t&&t>16)return t=Math.min(t-16,250),void(n=setTimeout(r,250))
void 0!==e&&g()-e<10||(null!=n&&(clearTimeout(n),n=null),e=g(),I(),t=g()-e)}
...
var L={center:"center",left:"right",right:"left"},F={middle:"middle",top:"bottom",bottom:"top"},B={top:0,left:0,middle:"50%",center:"50%",bottom:"100%",right:"100%"},U=function(e,t){var n=e.left,r=e.top
return"auto"===n&&(n=L[t.left]),"auto"===r&&(r=F[t.top]),{left:n,top:r}},z=function(e){var t=e.left,n=e.top
return void 0!==B[e.left]&&(t=B[e.left]),void 0!==B[e.top]&&(n=B[e.top]),{left:t,top:n}},H=function(e){var t=e.split(" "),n=N(t,2)
return{top:n[0],left:n[1]}},q=H,V=function(t){function c(t){var n=this
e(this,c),j(Object.getPrototypeOf(c.prototype),"constructor",this).call(this),this.position=this.position.bind(this),M.push(this),this.history=[],this.setOptions(t,!1),w.modules.forEach(function(e){void 0!==e.initialize&&e.initialize.call(n)}),this.position()}return d(c,t),_(c,[{key:"getClass",value:function(){var e=arguments.length<=0||void 0===arguments[0]?"":arguments[0],t=this.options.classes
return void 0!==t&&t[e]?this.options.classes[e]:this.options.classPrefix?this.options.classPrefix+"-"+e:e}},{key:"setOptions",value:function(e){var t=this,r=arguments.length<=1||void 0===arguments[1]||arguments[1],i={offset:"0 0",targetOffset:"0 0",targetAttachment:"auto auto",classPrefix:"tether"}
this.options=a(i,e)
var o=this.options,s=o.element,u=o.target,c=o.targetModifier
...
void 0!==t[e].jquery?t[e]=t[e][0]:"string"==typeof t[e]&&(t[e]=document.querySelector(t[e]))}),l(this.element,this.getClass("element")),!1!==this.options.addTargetClasses&&l(this.target,this.getClass("target")),!this.options.attachment)throw new Error("Tether Error: You must provide an attachment")
this.targetAttachment=q(this.options.targetAttachment),this.attachment=q(this.options.attachment),this.offset=H(this.options.offset),this.targetOffset=H(this.options.targetOffset),void 0!==this.scrollParents&&this.disable(),"scroll-handle"===this.targetModifier?this.scrollParents=[this.target]:this.scrollParents=n(this.target),!1!==this.options.enabled&&this.enable(r)}},{key:"getTargetBounds",value:function(){if(void 0===this.targetModifier)return i(this.target)
...
var e=i(this.target),t={height:e.height,width:e.width,top:e.top,left:e.left}
...
n===document.body?(n=document.documentElement,e={left:pageXOffset,top:pageYOffset,height:innerHeight,width:innerWidth}):e=i(n)
...
o&&(s=15)
var a=e.height-parseFloat(r.borderTopWidth)-parseFloat(r.borderBottomWidth)-s,t={width:15,height:.975*a*(a/n.scrollHeight),left:e.left+e.width-parseFloat(r.borderLeftWidth)-15},u=0
...
u(this.target,this.getClass("enabled")),u(this.element,this.getClass("enabled")),this.enabled=!1,void 0!==this.scrollParents&&this.scrollParents.forEach(function(t){t.removeEventListener("scroll",e.position)})}},{key:"destroy",value:function(){var e=this
this.disable(),M.forEach(function(t,n){t===e&&M.splice(n,1)}),0===M.length&&r()}},{key:"updateAttachClasses",value:function(e,t){var n=this
...
var o=[]
r.forEach(function(e){o.push(n.getClass("element-attached")+"-"+e),o.push(n.getClass("target-attached")+"-"+e)}),T(function(){void 0!==n._addAttachClasses&&(h(n.element,n._addAttachClasses,o),!1!==n.options.addTargetClasses&&h(n.target,n._addAttachClasses,o),delete n._addAttachClasses)})}},{key:"position",value:function(){var e=this,t=arguments.length<=0||void 0===arguments[0]||arguments[0]
if(this.enabled){this.clearCache()
var n=U(this.targetAttachment,this.attachment)
this.updateAttachClasses(this.attachment,n)
var r=this.cache("element-bounds",function(){return i(e.element)}),a=r.width,u=r.height
if(0===a&&0===u&&void 0!==this.lastSize){var l=this.lastSize
a=l.width,u=l.height}else this.lastSize={width:a,height:u}
var c=this.cache("target-bounds",function(){return e.getTargetBounds()}),p=c,f=y(z(this.attachment),{width:a,height:u}),h=y(z(n),p),d=y(this.offset,{width:a,height:u}),m=y(this.targetOffset,p)
f=v(f,d),h=v(h,m)
for(var g=c.left+h.left-f.left,b=c.top+h.top-f.top,_=0;_<w.modules.length;++_){var E=w.modules[_],x=E.position.call(this,{left:g,top:b,targetAttachment:n,targetPos:c,elementPos:r,offset:f,targetOffset:h,manualOffset:d,manualTargetOffset:m,scrollbarSize:S,attachment:this.attachment})
if(!1===x)return!1
void 0!==x&&"object"==typeof x&&(b=x.top,g=x.left)}var C={page:{top:b,left:g},viewport:{top:b-pageYOffset,bottom:pageYOffset-b-u+innerHeight,left:g-pageXOffset,right:pageXOffset-g-a+innerWidth}},O=this.target.ownerDocument,A=O.defaultView,S=void 0
return A.innerHeight>O.documentElement.clientHeight&&(S=this.cache("scrollbar-size",s),C.viewport.bottom-=S.height),A.innerWidth>O.documentElement.clientWidth&&(S=this.cache("scrollbar-size",s),C.viewport.right-=S.width),-1!==["","static"].indexOf(O.body.style.position)&&-1!==["","static"].indexOf(O.body.parentElement.style.position)||(C.page.bottom=O.body.scrollHeight-b-u,C.page.right=O.body.scrollWidth-g-a),void 0!==this.options.optimizations&&!1!==this.options.optimizations.moveElement&&void 0===this.targetModifier&&function(){var t=e.cache("target-offsetparent",function(){return o(e.target)}),n=e.cache("target-offsetparent-bounds",function(){return i(t)}),r=getComputedStyle(t),s=n,a={}
if(["Top","Left","Bottom","Right"].forEach(function(e){a[e.toLowerCase()]=parseFloat(r["border"+e+"Width"])}),n.right=O.body.scrollWidth-n.left-s.width+a.right,n.bottom=O.body.scrollHeight-n.top-s.height+a.bottom,C.page.top>=n.top+a.top&&C.page.bottom>=n.bottom&&C.page.left>=n.left+a.left&&C.page.right>=n.right){var u=t.scrollTop,l=t.scrollLeft
C.offset={top:C.page.top-n.top+u-a.top,left:C.page.left-n.left+l-a.left}}}(),this.move(C),this.history.unshift(C),this.history.length>3&&this.history.pop(),t&&R(),!0}}},{key:"move",value:function(e){var t=this
if(void 0!==this.element.parentNode){var n={}
for(var r in e){n[r]={}
for(var i in e[r]){for(var s=!1,u=0;u<this.history.length;++u){var l=this.history[u]
if(void 0!==l[r]&&!m(l[r][i],e[r][i])){s=!0
break}}s||(n[r][i]=!0)}}var c={top:"",left:"",right:"",bottom:""},p=function(e,n){if(!1!==(void 0!==t.options.optimizations?t.options.optimizations.gpu:null)){var r=void 0,i=void 0
e.top?(c.top=0,r=n.top):(c.bottom=0,r=-n.bottom),e.left?(c.left=0,i=n.left):(c.right=0,i=-n.right),window.matchMedia&&(window.matchMedia("only screen and (min-resolution: 1.3dppx)").matches||window.matchMedia("only screen and (-webkit-min-device-pixel-ratio: 1.3)").matches||(i=Math.round(i),r=Math.round(r))),c[D]="translateX("+i+"px) translateY("+r+"px)","msTransform"!==D&&(c[D]+=" translateZ(0)")}else e.top?c.top=n.top+"px":c.bottom=n.bottom+"px",e.left?c.left=n.left+"px":c.right=n.right+"px"},f=!1
...
var r=t.cache("target-offsetparent",function(){return o(t.target)})
o(t.element)!==r&&T(function(){t.element.parentNode.removeChild(t.element),r.appendChild(t.element)}),p(n.offset,e.offset),f=!0}():(c.position="absolute",p({top:!0,left:!0},e.page)),!f)if(this.options.bodyElement)this.element.parentNode!==this.options.bodyElement&&this.options.bodyElement.appendChild(this.element)
else{for(var h=!0,d=this.element.parentNode;d&&1===d.nodeType&&"BODY"!==d.tagName;){if("static"!==getComputedStyle(d).position){h=!1
break}d=d.parentNode}h||(this.element.parentNode.removeChild(this.element),this.element.ownerDocument.body.appendChild(this.element))}var g={},v=!1
for(var i in c){var y=c[i]
this.element.style[i]!==y&&(v=!0,g[i]=y)}v&&T(function(){a(t.element.style,g),t.trigger("repositioned")})}}}]),c}(k)
V.modules=[],w.position=I
var W=a(V,w),N=function(){function e(e,t){var n=[],r=!0,i=!1,o=void 0
try{for(var s,a=e[Symbol.iterator]();!(r=(s=a.next()).done)&&(n.push(s.value),!t||n.length!==t);r=!0);}catch(e){i=!0,o=e}finally{try{!r&&a.return&&a.return()}finally{if(i)throw o}}return n}return function(t,n){if(Array.isArray(t))return t
if(Symbol.iterator in Object(t))return e(t,n)
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),P=w.Utils,i=P.getBounds,a=P.extend,h=P.updateClasses,T=P.defer,G=["left","top","right","bottom"]
w.modules.push({position:function(e){var t=this,n=e.top,r=e.left,o=e.targetAttachment
if(!this.options.constraints)return!0
var s=this.cache("element-bounds",function(){return i(t.element)}),u=s.height,l=s.width
if(0===l&&0===u&&void 0!==this.lastSize){var c=this.lastSize
l=c.width,u=c.height}var p=this.cache("target-bounds",function(){return t.getTargetBounds()}),f=p.height,d=p.width,m=[this.getClass("pinned"),this.getClass("out-of-bounds")]
this.options.constraints.forEach(function(e){var t=e.outOfBoundsClass,n=e.pinnedClass
t&&m.push(t),n&&m.push(n)}),m.forEach(function(e){["left","top","right","bottom"].forEach(function(t){m.push(e+"-"+t)})})
var g=[],v=a({},o),y=a({},this.attachment)
return this.options.constraints.forEach(function(e){var i=e.to,s=e.attachment,a=e.pin
void 0===s&&(s="")
var c=void 0,p=void 0
if(s.indexOf(" ")>=0){var h=s.split(" "),m=N(h,2)
p=m[0],c=m[1]}else c=p=s
var _=b(t,i)
"target"!==p&&"both"!==p||(n<_[1]&&"top"===v.top&&(n+=f,v.top="bottom"),n+u>_[3]&&"bottom"===v.top&&(n-=f,v.top="top")),"together"===p&&("top"===v.top&&("bottom"===y.top&&n<_[1]?(n+=f,v.top="bottom",n+=u,y.top="top"):"top"===y.top&&n+u>_[3]&&n-(u-f)>=_[1]&&(n-=u-f,v.top="bottom",y.top="bottom")),"bottom"===v.top&&("top"===y.top&&n+u>_[3]?(n-=f,v.top="top",n-=u,y.top="bottom"):"bottom"===y.top&&n<_[1]&&n+(2*u-f)<=_[3]&&(n+=u-f,v.top="top",y.top="top")),"middle"===v.top&&(n+u>_[3]&&"top"===y.top?(n-=u,y.top="bottom"):n<_[1]&&"bottom"===y.top&&(n+=u,y.top="top"))),"target"!==c&&"both"!==c||(r<_[0]&&"left"===v.left&&(r+=d,v.left="right"),r+l>_[2]&&"right"===v.left&&(r-=d,v.left="left")),"together"===c&&(r<_[0]&&"left"===v.left?"right"===y.left?(r+=d,v.left="right",r+=l,y.left="left"):"left"===y.left&&(r+=d,v.left="right",r-=l,y.left="right"):r+l>_[2]&&"right"===v.left?"left"===y.left?(r-=d,v.left="left",r-=l,y.left="right"):"right"===y.left&&(r-=d,v.left="left",r+=l,y.left="left"):"center"===v.left&&(r+l>_[2]&&"left"===y.left?(r-=l,y.left="right"):r<_[0]&&"right"===y.left&&(r+=l,y.left="left"))),"element"!==p&&"both"!==p||(n<_[1]&&"bottom"===y.top&&(n+=u,y.top="top"),n+u>_[3]&&"top"===y.top&&(n-=u,y.top="bottom")),"element"!==c&&"both"!==c||(r<_[0]&&("right"===y.left?(r+=l,y.left="left"):"center"===y.left&&(r+=l/2,y.left="left")),r+l>_[2]&&("left"===y.left?(r-=l,y.left="right"):"center"===y.left&&(r-=l/2,y.left="right"))),"string"==typeof a?a=a.split(",").map(function(e){return e.trim()}):!0===a&&(a=["top","left","right","bottom"]),a=a||[]
var w=[],E=[]
n<_[1]&&(a.indexOf("top")>=0?(n=_[1],w.push("top")):E.push("top")),n+u>_[3]&&(a.indexOf("bottom")>=0?(n=_[3]-u,w.push("bottom")):E.push("bottom")),r<_[0]&&(a.indexOf("left")>=0?(r=_[0],w.push("left")):E.push("left")),r+l>_[2]&&(a.indexOf("right")>=0?(r=_[2]-l,w.push("right")):E.push("right")),w.length&&function(){var e=void 0
e=void 0!==t.options.pinnedClass?t.options.pinnedClass:t.getClass("pinned"),g.push(e),w.forEach(function(t){g.push(e+"-"+t)})}(),E.length&&function(){var e=void 0
e=void 0!==t.options.outOfBoundsClass?t.options.outOfBoundsClass:t.getClass("out-of-bounds"),g.push(e),E.forEach(function(t){g.push(e+"-"+t)})}(),(w.indexOf("left")>=0||w.indexOf("right")>=0)&&(y.left=v.left=!1),(w.indexOf("top")>=0||w.indexOf("bottom")>=0)&&(y.top=v.top=!1),v.top===o.top&&v.left===o.left&&y.top===t.attachment.top&&y.left===t.attachment.left||(t.updateAttachClasses(y,v),t.trigger("update",{attachment:y,targetAttachment:v}))}),T(function(){!1!==t.options.addTargetClasses&&h(t.target,g,m),h(t.element,g,m)}),{top:n,left:r}}})
var P=w.Utils,i=P.getBounds,h=P.updateClasses,T=P.defer
w.modules.push({position:function(e){var t=this,n=e.top,r=e.left,o=this.cache("element-bounds",function(){return i(t.element)}),s=o.height,a=o.width,u=this.getTargetBounds(),l=n+s,c=r+a,p=[]
...
t!==n&&t!==l||p.push(e)})
var f=[],d=[],m=["left","top","right","bottom"]
return f.push(this.getClass("abutted")),m.forEach(function(e){f.push(t.getClass("abutted")+"-"+e)}),p.length&&d.push(this.getClass("abutted")),p.forEach(function(e){d.push(t.getClass("abutted")+"-"+e)}),T(function(){!1!==t.options.addTargetClasses&&h(t.target,d,f),h(t.element,d,f)}),!0}})
var N=function(){function e(e,t){var n=[],r=!0,i=!1,o=void 0
try{for(var s,a=e[Symbol.iterator]();!(r=(s=a.next()).done)&&(n.push(s.value),!t||n.length!==t);r=!0);}catch(e){i=!0,o=e}finally{try{!r&&a.return&&a.return()}finally{if(i)throw o}}return n}return function(t,n){if(Array.isArray(t))return t
if(Symbol.iterator in Object(t))return e(t,n)
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}()
return w.modules.push({position:function(e){var t=e.top,n=e.left
...
return t+=i,n+=o,{top:t,left:n}}}}),W}),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
...
var d="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},m=Ember.Logger,g=Ember.Test,v=Ember.testing,y=/^application\/(?:vnd\.api\+)?json/i,b=0
v&&g.registerWaiter(function(){return 0===b}),e.default=Ember.Mixin.create({contentType:"application/x-www-form-urlencoded; charset=UTF-8",headers:{},request:function(e,t){var n=this.options(e,t),r=this._makeRequest(n),i=new a.default(function(e,t){r.then(function(t){var n=t.response
...
function t(){var e=Object.create(null)
return e._dict=null,delete e._dict,e}Object.defineProperty(e,"__esModule",{value:!0}),e.default=t}),define("ember-tether/components/ember-tether",["exports"],function(e){"use strict"
...
Ember.isNone(r)||(t[n]=r)}),t}})}),define("ember-tooltips/components/lazy-render-wrapper",["exports","ember-tooltips/templates/components/lazy-render-wrapper"],function(e,t){"use strict"
function n(e){return""===a(e,"tagName")?o(i&&i.getViewBounds?i.getViewBounds(e).parentElement:e._renderNode.contextualElement):e.$().parent()}Object.defineProperty(e,"__esModule",{value:!0}),e.TARGET_EVENT_NAMESPACE=void 0
var r=Ember.Component,i=Ember.ViewUtils,o=Ember.$,s=Ember.computed,a=Ember.get,u=Ember.isNone,l=Ember.warn,c=e.TARGET_EVENT_NAMESPACE="target-lazy-render-wrapper",p=["delay","delayOnChange","duration","effect","event","hideOn","keepInWindow","setPin","side","showOn","spacing","isShown","tooltipIsVisible","hideDelay","target","text","updateFor","targetAttachment","attachment","role","tabindex","_shouldTargetGrandparentView"],f=["onDestroy","onHide","onRender","onShow","onTooltipDestroy","onTooltipHide","onTooltipRender","onTooltipShow"],h=p.concat(f)
e.default=r.extend({tagName:"",layout:t.default,enableLazyRendering:!1,event:"hover",_childView:null,_hasUserInteracted:!1,_hasRendered:!1,_shouldShowOnRender:!1,passedPropertiesObject:s.apply(void 0,function(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t]
return n}return Array.from(e)}(h).concat([function(){var e=this
return h.reduce(function(t,n){var r=e.get(n)
return u(r)||(f.indexOf(n)>=0?t[n]=function(){return e.sendAction(n)}:t[n]=r),t},{})}])),$target:s("target","tetherComponentName",function(){var e=this.get("target"),t=void 0
if(e)t=o(e)
else if(this.get("tetherComponentName").indexOf("-on-component")>=0){var r=this.get("parentView")
if(!r)return l("No targetView found"),null
if(!r.get("elementId"))return l("No targetView.elementId"),null
var i=r.get("elementId")
t=o("#"+i)}else t=n(this)
return t}),_shouldRender:s("isShown","tooltipIsVisible","enableLazyRendering","_hasUserInteracted",function(){return!!this.get("_hasRendered")||(this.get("isShown")||this.get("tooltipIsVisible")?(this.set("_hasRendered",!0),!0):this.get("enableLazyRendering")?!!this.get("_hasUserInteracted")&&(this.set("_hasRendered",!0),!0):(this.set("_hasRendered",!0),!0))}),_lazyRenderEvents:s("event",function(){var e=this.get("event")
if("none"===e)return[]
var t=["focusin"]
return"hover"===e?t.push("mouseenter"):"click"===e&&t.push("click"),t}),didInsertElement:function(){var e=this
if(this._super.apply(this,arguments),!this.get("_shouldRender")){var t=this.get("$target")
"hover"===this.get("event")&&t.on("mouseleave."+c,function(){e.set("_shouldShowOnRender",!1)}),this.get("_lazyRenderEvents").forEach(function(n){t.on(n+"."+c,function(){e.get("_hasUserInteracted")?t.off(n+"."+c):(e.set("_hasUserInteracted",!0),e.set("_shouldShowOnRender",!0),e.set("_isInProcessOfShowing",!0))})})}},willDestroyElement:function(){this._super.apply(this,arguments)
var e=this.get("$target")
this.get("_lazyRenderEvents").forEach(function(t){e.off(t+"."+c)}),e.off("mouseleave."+c)},actions:{hide:function(){var e=this.get("_childView")
if(e){var t=e.actions||e._actions
t&&t.hide&&e.send("hide")}}}})}),define("ember-tooltips/components/popover-on-component",["exports","ember-tooltips/components/popover-on-element"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({tetherComponentName:"tether-popover-on-component",_shouldTargetGrandparentView:!0})}),define("ember-tooltips/components/popover-on-element",["exports","ember-tooltips/components/lazy-render-wrapper"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({tetherComponentName:"tether-popover-on-element"})}),define("ember-tooltips/components/tether-popover-on-component",["exports","ember-tooltips/components/tether-popover-on-element","ember-tooltips/utils"],function(e,t,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({target:n.onComponentTarget})}),define("ember-tooltips/components/tether-popover-on-element",["exports","ember-tooltips/components/tether-tooltip-and-popover","ember-tooltips/templates/components/tether-popover"],function(e,t,n){"use strict"
function r(e,t){return!!t&&(t.is(e)||!!t.find(e).length)}function i(e,t,n){return!(!t||!n)&&(!!t.is(e)||!!t.find(e).length&&!r(e,n))}function o(e,t,n){var o=!r(e,n)
return!i(e,t,n)&&o}Object.defineProperty(e,"__esModule",{value:!0}),e.isElementInPopover=r,e.isElementInTargetAndNotInPopover=i,e.isElementElsewhere=o
var s=Ember.$,a=Ember.run
e.default=t.default.extend({hideDelay:250,classNames:["ember-popover"],layout:n.default,_isMouseInside:!1,didRender:function(){this._super.apply(this,arguments)
var e=this.get("parentView")
e&&e.set("_childView",this)},didInsertElement:function(){var e=this
this._super.apply(this,arguments)
var t=this.get("event"),n=this.get("target"),u=s(n),l=this.$()
if("none"!==t){if("hover"===t){var c=this.get("_showOn"),p=this.get("_hideOn")
u.on(c,function(){return e.show()}),u.add(l).on(p,function(){e.set("_isMouseInside",!1)
var t=+e.get("hideDelay"),n=function(){e.get("_isMouseInside")||e.hide()}
t?a.later(function(){n()},t):n()}),u.add(l).on("mouseover",function(){return e.set("_isMouseInside",!0)})}else"click"===t&&s(document).on("click."+n,function(t){var n=o(t.target,u,l),s=i(t.target,u,l),a=r(t.target,l),c=e.get("isShown")
n&&c?e.hide():!a&&s&&(e.get("_isInProcessOfShowing")?e.set("_isInProcessOfShowing",!1):e.toggle())})
u.on("focus",function(){e.set("_isInProcessOfShowing",!0),e.show()}),u.add(l).on("focusout",function(){a.later(function(){o(document.activeElement,u,l)&&e.hide()})})}},willDestroyElement:function(){this._super.apply(this,arguments)
var e=this.get("target"),t=s(e),n=this.$(),r=this.get("_showOn"),i=this.get("_hideOn")
t.add(n).off(r+" mouseover "+i+" focus focusout"),s(document).off("click."+e)},actions:{hide:function(){this.hide()}}})}),define("ember-tooltips/components/tether-tooltip-and-popover",["exports","ember-tether/components/ember-tether"],function(e,t){"use strict"
function n(e){var t=void 0
return e&&"string"==typeof e?(t=parseInt(e,10),!isNaN(t)&&isFinite(t)||(t=0)):t=e,t}Object.defineProperty(e,"__esModule",{value:!0})
var r=Ember.$,i=Ember.assert,o=Ember.computed,s=Ember.observer,a=Ember.on,u=Ember.run,l=0
e.default=t.default.extend({passedPropertiesObject:null,setPropertiesWithPassedPropertiesObject:a("didReceiveAttrs",function(){this._super.apply(this,arguments)
var e=this.get("passedPropertiesObject")
e&&this.setProperties(e)}),delay:0,delayOnChange:!0,duration:0,effect:"slide",event:"hover",hideOn:null,role:"tooltip",side:"top",showOn:null,spacing:10,tabindex:"0",isShown:!1,tooltipIsVisible:o.deprecatingAlias("isShown",{id:"tooltip-and-popover.tooltipIsVisible",until:"3.0.0"}),keepInWindow:!0,updateFor:null,onDestroy:null,onHide:null,onRender:null,onShow:null,onTooltipDestroy:o.deprecatingAlias("onDestroy",{id:"tooltip-and-popover.onTooltipDestroy",until:"3.0.0"}),onTooltipHide:o.deprecatingAlias("onHide",{id:"tooltip-and-popover.onTooltipHide",until:"3.0.0"}),onTooltipRender:o.deprecatingAlias("onRender",{id:"tooltip-and-popover.onTooltipRender",until:"3.0.0"}),onTooltipShow:o.deprecatingAlias("onShow",{id:"tooltip-and-popover.onTooltipShow",until:"3.0.0"}),attributeBindings:["role","tabindex"],classNameBindings:["effectClass"],classPrefix:"ember-tooltip-or-popover",_didUpdateTimeoutLength:1e3,_hideTimer:null,_showTimer:null,_isTetherEnabled:!0,dataTetherEnabledHandler:s("_isTetherEnabled",function(){var e=this.get("_isTetherEnabled")?"true":"false",t=this.$()
t&&t.attr&&t.attr("data-tether-enabled",e)}),ariaHiddenHandler:s("isShown",function(){var e=this.get("isShown")?"false":"true",t=this.$()
t&&t.attr&&t.attr("aria-hidden",e)}),attachment:o(function(){var e=this.get("side"),t=void 0,n=void 0
switch(e){case"top":t="center",n="bottom"
break
case"right":t="left",n="center"
break
case"bottom":t="center",n="top"
break
case"left":t="right",n="center"}return n+" "+t}),constraints:o("keepInWindow","setPin",function(){var e=void 0
return this.get("keepInWindow")&&(e=[{to:"window",attachment:"together",pin:this.get("setPin")}]),e}),effectClass:o(function(){return this.get("classPrefix")+"-"+this.get("effect")}),positionClass:o(function(){var e=this.get("targetAttachment"),t=this.get("classPrefix")
return t+"-"+e.replace(" "," "+t+"-")}),sideIsVertical:o(function(){var e=this.get("side")
return"top"===e||"bottom"===e}),target:o(function(){var e=this.$()
if(!e)return null
var t=e.parent(),n=t&&t.attr("id")
return n||(n="target-for-tooltip-or-popover-"+l,l++,t.attr("id",n)),"#"+n}),targetAttachment:o(function(){var e=this.get("side")
return this.get("sideIsVertical")?e+" center":"center "+e}),typeClass:o(function(){var e=this.get("type"),t=this.get("classPrefix")
return e?t+"-"+e:null}),_hideOn:o(function(){var e=this.get("hideOn")
if(!e){var t=this.get("event")
...
case"ready":e=null
break
default:e=t}}return e}),_showOn:o(function(){var e=this.get("showOn")
if(!e){var t=this.get("event")
switch(t){case"hover":e="mouseenter"
break
default:e=t}}return e}),hide:function(){this.isDestroying||this.isDestroyed||(u.cancel(this.get("_showTimer")),this.set("isShown",!1),this.sendAction("onHide",this),this.stopTether())},didInsertElement:function(){var e=this
this._super.apply(this,arguments),this.get("_shouldShowOnRender")&&this.show()
var t=this.get("target")
t&&-1!==t.indexOf("#")||i('You must specify a target attribute in the format target="#element-id" for the tooltip component')
var n=r(this.get("target")),o=this.get("_tether"),s=r(o.element)
this.sendAction("onRender",this),n.attr({"aria-describedby":""+this.get("elementId"),tabindex:n.attr("tabindex")||this.get("tabindex")}),this.ariaHiddenHandler(),this.dataTetherEnabledHandler()
var a=void 0;["top","right","bottom","left"].forEach(function(t){s.hasClass(e.get("classPrefix")+"-target-attached-"+t)&&(a=t)})
var u=this.get("spacing"),l=void 0
switch(a){case"top":l=u+"px 0"
break
case"right":l="0 -"+u+"px"
break
case"bottom":l="-"+u+"px 0"
break
case"left":l="0 "+u+"px"}this.set("offset",l),this.get("isShown")||this.stopTether()},didUpdate:function(){var e=this
this._super.apply(this,arguments),u.later(function(){e.positionTether(),e.isDestroying||e.isDestroyed||e.sendAction("onRender",e)},this.get("_didUpdateTimeoutLength"))},setTimer:s("isShown",function(){if(this.get("isShown")){this.startTether()
var e=n(this.get("duration"))
if(u.cancel(this.get("_hideTimer")),e){var t=u.later(this,this.hide,e)
this.set("_hideTimer",t)}}else this.stopTether()}),show:function(){var e=this
if(this.positionTether(),!this.isDestroying&&!this.isDestroyed){var t=this.get("_showTimer"),i=n(this.get("delay"))
if(u.cancel(t),i){if(!this.get("delayOnChange")){r("."+this.get("classPrefix")+'-element[aria-hidden="false"]').length&&(i=0)}var o=u.later(this,function(){e.get("destroying")||e.get("isDestroyed")||(e.startTether(),e.set("isShown",!0))},i)
this.set("_showTimer",o)}else this.startTether(),this.set("isShown",!0)
this.sendAction("onShow",this)}},toggle:function(){this.get("isShown")?this.hide():this.show()},willDestroyElement:function(){var e=r&&r(this.get("target"))
this.set("effect",null),this.get("isShown")&&this.hide(),e&&(e.removeAttr("aria-describedby"),e.off()),this._super.apply(this,arguments),this.sendAction("onDestroy",this)},startTether:function(){var e=this
u.schedule("afterRender",function(){e.isDestroyed||e.isDestroying||(e.set("_isTetherEnabled",!0),e.get("_tether").enable())})},stopTether:function(){var e=this
u.schedule("afterRender",function(){e.isDestroyed||e.isDestroying||(e.set("_isTetherEnabled",!1),e.get("_tether").disable())})},_tetherDidChange:function(){this.removeTether(this._tether),this.addTether()},tetherDidChange:s("classPrefix","target","attachment","targetAttachment","offset","targetOffset","targetModifier","constraints","optimizations",function(){var e=this
this.element?this._tetherDidChange():u.schedule("afterRender",function(){return e._tetherDidChange()})})})}),define("ember-tooltips/components/tether-tooltip-on-component",["exports","ember-tooltips/components/tether-tooltip-on-element","ember-tooltips/utils"],function(e,t,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({target:n.onComponentTarget})}),define("ember-tooltips/components/tether-tooltip-on-element",["exports","ember-tooltips/components/tether-tooltip-and-popover"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var n=Ember.$
e.default=t.default.extend({classNames:["ember-tooltip"],didInsertElement:function(){var e=this
this._super.apply(this,arguments)
var t=n(this.get("target")),r=this.get("event")
if("none"!==r){var i=this.get("_hideOn"),o=this.get("_showOn")
o===i?t.on(o,function(){e.get("_isInProcessOfShowing")?e.set("_isInProcessOfShowing",!1):e.toggle()}):("none"!==o&&t.on(o,function(){e.show()}),"none"!==i&&t.on(i,function(){e.hide()})),"focus"!==r&&("click"!==r&&t.focusin(function(){e.show()}),t.focusout(function(){e.hide()})),t.keydown(function(t){if(27===t.which)return e.hide(),t.preventDefault(),!1})}}})}),define("ember-tooltips/components/tooltip-on-component",["exports","ember-tooltips/components/tooltip-on-element"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({tetherComponentName:"tether-tooltip-on-component",_shouldTargetGrandparentView:!0})}),define("ember-tooltips/components/tooltip-on-element",["exports","ember-tooltips/components/lazy-render-wrapper"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({tetherComponentName:"tether-tooltip-on-element"})}),define("ember-tooltips/templates/components/lazy-render-wrapper",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"jsR5FjXj",block:'{"statements":[[6,["if"],[[28,["_shouldRender"]]],null,{"statements":[[6,["component"],[[28,["tetherComponentName"]]],[["passedPropertiesObject","class","id","classNames","_shouldShowOnRender","_isInProcessOfShowing"],[[28,["passedPropertiesObject"]],[28,["class"]],[28,["id"]],[28,["classNames"]],[28,["_shouldShowOnRender"]],[28,["_isInProcessOfShowing"]]]],{"statements":[[6,["if"],[[29,"default"]],null,{"statements":[[0,"      "],[18,"default",[[33,["hash"],null,[["hide"],[[33,["action"],[[28,[null]],"hide"],null]]]]]],[0,"\\n"]],"locals":[]},{"statements":[[0,"      "],[1,[26,["text"]],false],[0,"\\n"]],"locals":[]}]],"locals":[]},null]],"locals":[]},null],[0,"\\n"]],"locals":[],"named":[],"yields":["default"],"hasPartials":false}',meta:{moduleName:"ember-tooltips/templates/components/lazy-render-wrapper.hbs"}})}),define("ember-tooltips/templates/components/tether-popover",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"tS69WG9W",block:'{"statements":[[18,"default",[[33,["hash"],null,[["hide"],[[33,["action"],[[28,[null]],"hide"],null]]]]]],[0,"\\n"]],"locals":[],"named":[],"yields":["default"],"hasPartials":false}',meta:{moduleName:"ember-tooltips/templates/components/tether-popover.hbs"}})}),define("ember-tooltips/utils",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var t=Ember.computed,n=Ember.warn
e.onComponentTarget=t(function(){var e=void 0
return e=this.get("_shouldTargetGrandparentView")?this.get("parentView.parentView"):this.get("parentView"),e?e.get("elementId")?"#"+e.get("elementId"):(n("No targetView.elementId"),null):(n("No targetView found"),null)})})
